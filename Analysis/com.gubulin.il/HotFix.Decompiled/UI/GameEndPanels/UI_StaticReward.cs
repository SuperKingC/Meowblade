...
public class UI_StaticReward : GButton
{
	...
	public const string URL = "ui://hda5vzklvv0u2q";

	public static string Name = "UI_StaticReward";

	public static string GetURL()
	{
		return "ui://hda5vzklvv0u2q";
	}

	public static UI_StaticReward CreateInstance()
	{
		return (UI_StaticReward)(object)UIPackage.CreateObject("GameEndPanels", "StaticReward");
	}
	...
	public static UI_StaticReward CreateInstance_ILRuntime()
	{
		...
		UIObjectFactory.SetPackageItemExtension("ui://hda5vzklvv0u2q", (GComponentCreator)(() => HotFixManager.Instance.appdomain.Instantiate<GComponent>(full_name, (object[])null)));
