...
public class UI_com_EnemyStandardFormationSketchMap : GComponent
{
	...
	public const string URL = "ui://b3fc6085stwv11";

	public static string Name = "UI_com_EnemyStandardFormationSketchMap";

	public static string GetURL()
	{
		return "ui://b3fc6085stwv11";
	}

	public static UI_com_EnemyStandardFormationSketchMap CreateInstance()
	{
		return (UI_com_EnemyStandardFormationSketchMap)(object)UIPackage.CreateObject("GvGBattleRecord3", "com_EnemyStandardFormationSketchMap");
	}

	public static UI_com_EnemyStandardFormationSketchMap CreateInstance_ILRuntime()
	{
		//IL_0028: Unknown result type (might be due to invalid IL or missing references)
		//IL_0032: Expected O, but got Unknown
		string full_name = typeof(UI_com_EnemyStandardFormationSketchMap).FullName;
		UIObjectFactory.SetPackageItemExtension("ui://b3fc6085stwv11", (GComponentCreator)(() => HotFixManager.Instance.appdomain.Instantiate<GComponent>(full_name, (object[])null)));
