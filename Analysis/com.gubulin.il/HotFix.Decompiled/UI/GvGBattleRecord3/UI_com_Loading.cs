...
public class UI_com_Loading : GComponent
{
	...
	public const string URL = "ui://b3fc6085stwv1w";

	public static string Name = "UI_com_Loading";

	public static string GetURL()
	{
		return "ui://b3fc6085stwv1w";
	}

	public static UI_com_Loading CreateInstance()
	{
		return (UI_com_Loading)(object)UIPackage.CreateObject("GvGBattleRecord3", "com_Loading");
	}
	...
	public static UI_com_Loading CreateInstance_ILRuntime()
	{
		...
		UIObjectFactory.SetPackageItemExtension("ui://b3fc6085stwv1w", (GComponentCreator)(() => HotFixManager.Instance.appdomain.Instantiate<GComponent>(full_name, (object[])null)));
