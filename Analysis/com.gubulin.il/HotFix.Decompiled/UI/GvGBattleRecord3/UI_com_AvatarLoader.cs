...
public class UI_com_AvatarLoader : GComponent
{
	...
	public const string URL = "ui://b3fc6085stwv1o";

	public static string Name = "UI_com_AvatarLoader";

	public static string GetURL()
	{
		return "ui://b3fc6085stwv1o";
	}

	public static UI_com_AvatarLoader CreateInstance()
	{
		return (UI_com_AvatarLoader)(object)UIPackage.CreateObject("GvGBattleRecord3", "com_AvatarLoader");
	}
	...
	public static UI_com_AvatarLoader CreateInstance_ILRuntime()
	{
		...
		UIObjectFactory.SetPackageItemExtension("ui://b3fc6085stwv1o", (GComponentCreator)(() => HotFixManager.Instance.appdomain.Instantiate<GComponent>(full_name, (object[])null)));
