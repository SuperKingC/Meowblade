...
public class UI_QualityIcon : GComponent
{
	...
	public const string URL = "ui://fpjheycbdc2jc";

	public static string Name = "UI_QualityIcon";

	public static string GetURL()
	{
		return "ui://fpjheycbdc2jc";
	}

	public static UI_QualityIcon CreateInstance()
	{
		return (UI_QualityIcon)(object)UIPackage.CreateObject("GvGAmplifierForge", "QualityIcon");
	}
	...
	public static UI_QualityIcon CreateInstance_ILRuntime()
	{
		...
		UIObjectFactory.SetPackageItemExtension("ui://fpjheycbdc2jc", (GComponentCreator)(() => HotFixManager.Instance.appdomain.Instantiate<GComponent>(full_name, (object[])null)));
