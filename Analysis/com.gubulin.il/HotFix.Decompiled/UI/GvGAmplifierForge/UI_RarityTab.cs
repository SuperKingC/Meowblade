...
public class UI_RarityTab : GButton
{
	...
	public const string URL = "ui://fpjheycbxe3q7";

	public static string Name = "UI_RarityTab";

	public static string GetURL()
	{
		return "ui://fpjheycbxe3q7";
	}

	public static UI_RarityTab CreateInstance()
	{
		return (UI_RarityTab)(object)UIPackage.CreateObject("GvGAmplifierForge", "RarityTab");
	}

	public static UI_RarityTab CreateInstance_ILRuntime()
	{
		//IL_0028: Unknown result type (might be due to invalid IL or missing references)
		//IL_0032: Expected O, but got Unknown
		string full_name = typeof(UI_RarityTab).FullName;
		UIObjectFactory.SetPackageItemExtension("ui://fpjheycbxe3q7", (GComponentCreator)(() => HotFixManager.Instance.appdomain.Instantiate<GComponent>(full_name, (object[])null)));
