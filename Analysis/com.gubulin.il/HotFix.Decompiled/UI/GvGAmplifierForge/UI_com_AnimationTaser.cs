...
public class UI_com_AnimationTaser : GComponent
{
	...
	public const string URL = "ui://fpjheycbncp32g";

	public static string Name = "UI_com_AnimationTaser";

	public static string GetURL()
	{
		return "ui://fpjheycbncp32g";
	}

	public static UI_com_AnimationTaser CreateInstance()
	{
		return (UI_com_AnimationTaser)(object)UIPackage.CreateObject("GvGAmplifierForge", "com_AnimationTaser");
	}
	...
	public static UI_com_AnimationTaser CreateInstance_ILRuntime()
	{
		...
		UIObjectFactory.SetPackageItemExtension("ui://fpjheycbncp32g", (GComponentCreator)(() => HotFixManager.Instance.appdomain.Instantiate<GComponent>(full_name, (object[])null)));
