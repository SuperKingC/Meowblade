...
public class UI_btn_TypeTab : GButton
{
	...
	public const string URL = "ui://tt2iq07oj1h83r";

	public static string Name = "UI_btn_TypeTab";

	public static string GetURL()
	{
		return "ui://tt2iq07oj1h83r";
	}

	public static UI_btn_TypeTab CreateInstance()
	{
		return (UI_btn_TypeTab)(object)UIPackage.CreateObject("GvGExchange3", "btn_TypeTab");
	}
	...
	public static UI_btn_TypeTab CreateInstance_ILRuntime()
	{
		...
		UIObjectFactory.SetPackageItemExtension("ui://tt2iq07oj1h83r", (GComponentCreator)(() => HotFixManager.Instance.appdomain.Instantiate<GComponent>(full_name, (object[])null)));
