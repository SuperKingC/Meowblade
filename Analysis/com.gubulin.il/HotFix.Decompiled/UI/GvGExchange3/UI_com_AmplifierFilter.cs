...
public class UI_com_AmplifierFilter : GComponent, IFairyComponent
{
	...
	public const string URL = "ui://tt2iq07odwxt8";

	public static string Name = "UI_com_AmplifierFilter";
	...
	{
		return "ui://tt2iq07odwxt8";
	}

	public static UI_com_AmplifierFilter CreateInstance()
	{
		return (UI_com_AmplifierFilter)(object)UIPackage.CreateObject("GvGExchange3", "com_AmplifierFilter");
	}

	public static UI_com_AmplifierFilter CreateInstance_ILRuntime()
	{
		//IL_0028: Unknown result type (might be due to invalid IL or missing references)
		//IL_0032: Expected O, but got Unknown
		string full_name = typeof(UI_com_AmplifierFilter).FullName;
		UIObjectFactory.SetPackageItemExtension("ui://tt2iq07odwxt8", (GComponentCreator)(() => HotFixManager.Instance.appdomain.Instantiate<GComponent>(full_name, (object[])null)));
	...
	public override void ConstructFromXML(XML xml)
	{
		...
		string id = "ui://tt2iq07odwxt8".Replace("ui://", "") + "-" + ((GObject)n122).id;
		((GObject)n122).text = LanguagesManager.GetDesc(id);
		n124 = (GTextField)((GComponent)this).GetChild("n124");
		string id2 = "ui://tt2iq07odwxt8".Replace("ui://", "") + "-" + ((GObject)n124).id;
		((GObject)n124).text = LanguagesManager.GetDesc(id2);
	}
	...
	public void Init()
	{
		...
		{
			UI_btn_RaceSelectionBtn uI_btn_RaceSelectionBtn = (UI_btn_RaceSelectionBtn)(object)((GComponent)RaceFilter).GetChildAt(i);
			eRace selectedIndex = (eRace)uI_btn_RaceSelectionBtn.Type.selectedIndex;
		...
		PropFilter.itemRenderer = (ListItemRenderer)delegate(int index, GObject o)
		{
			ModifierRenderer(index, (UI_btn_PropSelectionBtn)(object)o);
		};
	...
	private void OnSelectQuality(EventContext context)
	{
		...
		{
			UI_btn_QualitySelectionBtn uI_btn_QualitySelectionBtn = (UI_btn_QualitySelectionBtn)(object)((GComponent)QualityFilter).GetChildAt(QualityFilter.selectedIndex);
			SelectedQuality = uI_btn_QualitySelectionBtn.Quality.selectedIndex;
		}
	...
	private void OnShowSoldierFilter()
	{
		...
		{
			SoldierRenderer(i, (UI_btn_SoldierSelectionBtn)(object)o);
		};
	...
	{
		IsFiltering.selectedIndex = (IsAnySelected ? 1 : 0);
		OnFilterChange?.Invoke();
	}

	private void SoldierRenderer(int index, UI_btn_SoldierSelectionBtn item)
	{
		string soldierId = CurRaceSoldiers[index];
		RenderHelper_SimpleSquareSoldier.RenderSoldier(item.AffectedSoldier, soldierId);
	}

	private void ModifierRenderer(int index, UI_btn_PropSelectionBtn item)
	{
