...
public class UI_goodItemConsume : GButton
{
	...
	public const string URL = "ui://kt6rg65oos532h";

	public static string Name = "UI_goodItemConsume";

	public static string GetURL()
	{
		return "ui://kt6rg65oos532h";
	}

	public static UI_goodItemConsume CreateInstance()
	{
		return (UI_goodItemConsume)(object)UIPackage.CreateObject("PublicResources", "goodItemConsume");
	}
	...
	public static UI_goodItemConsume CreateInstance_ILRuntime()
	{
		...
		UIObjectFactory.SetPackageItemExtension("ui://kt6rg65oos532h", (GComponentCreator)(() => HotFixManager.Instance.appdomain.Instantiate<GComponent>(full_name, (object[])null)));
	...
	public override void ConstructFromXML(XML xml)
	{
		...
		string id = "ui://kt6rg65oos532h".Replace("ui://", "") + "-" + ((GObject)name).id;
