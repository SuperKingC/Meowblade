...
public class UI_com_SelectForgeUniversalLegendItem : GComponent
{
	...
	public const string URL = "ui://b9wlonaqsel003";

	public static string Name = "UI_com_SelectForgeUniversalLegendItem";

	public static string GetURL()
	{
		return "ui://b9wlonaqsel003";
	}

	public static UI_com_SelectForgeUniversalLegendItem CreateInstance()
	{
		return (UI_com_SelectForgeUniversalLegendItem)(object)UIPackage.CreateObject("LegendItemCultivation", "com_SelectForgeUniversalLegendItem");
	}
	...
	public static UI_com_SelectForgeUniversalLegendItem CreateInstance_ILRuntime()
	{
		...
		UIObjectFactory.SetPackageItemExtension("ui://b9wlonaqsel003", (GComponentCreator)(() => HotFixManager.Instance.appdomain.Instantiate<GComponent>(full_name, (object[])null)));
