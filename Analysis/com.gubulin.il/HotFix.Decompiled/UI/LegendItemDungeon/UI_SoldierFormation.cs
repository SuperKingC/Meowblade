...
public class UI_SoldierFormation : GButton
{
	...
	public const string URL = "ui://2eraz3j9et4r3t";

	public static string Name = "UI_SoldierFormation";

	public static string GetURL()
	{
		return "ui://2eraz3j9et4r3t";
	}

	public static UI_SoldierFormation CreateInstance()
	{
		return (UI_SoldierFormation)(object)UIPackage.CreateObject("LegendItemDungeon", "SoldierFormation");
	}
	...
	public static UI_SoldierFormation CreateInstance_ILRuntime()
	{
		...
		UIObjectFactory.SetPackageItemExtension("ui://2eraz3j9et4r3t", (GComponentCreator)(() => HotFixManager.Instance.appdomain.Instantiate<GComponent>(full_name, (object[])null)));
	...
	public override void ConstructFromXML(XML xml)
	{
		...
		string id = "ui://2eraz3j9et4r3t".Replace("ui://", "") + "-" + ((GObject)num).id;
