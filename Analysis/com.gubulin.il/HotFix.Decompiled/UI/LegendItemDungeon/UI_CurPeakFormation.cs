...
public class UI_CurPeakFormation : GComponent
{
	...
	public const string URL = "ui://2eraz3j9et4r3y";
	...
	{
		return "ui://2eraz3j9et4r3y";
	}

	public static UI_CurPeakFormation CreateInstance()
	{
		return (UI_CurPeakFormation)(object)UIPackage.CreateObject("LegendItemDungeon", "CurPeakFormation");
	}
	...
	public static UI_CurPeakFormation CreateInstance_ILRuntime()
	{
		...
		UIObjectFactory.SetPackageItemExtension("ui://2eraz3j9et4r3y", (GComponentCreator)(() => HotFixManager.Instance.appdomain.Instantiate<GComponent>(full_name, (object[])null)));
	...
	private void SelectArrayFormation(EventContext context)
	{
		...
		{
			curFid = text;
			UI_PresetFormationPanel.PeakBattleSelectArrayPanel.UpdateCurSelectFormation(text);
		}
	}
}
