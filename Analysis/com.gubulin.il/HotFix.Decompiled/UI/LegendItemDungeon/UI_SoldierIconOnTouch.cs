...
public class UI_SoldierIconOnTouch : GComponent
{
	...
	public const string URL = "ui://2eraz3j9jg6431";

	public static string Name = "UI_SoldierIconOnTouch";

	public static string GetURL()
	{
		return "ui://2eraz3j9jg6431";
	}

	public static UI_SoldierIconOnTouch CreateInstance()
	{
		return (UI_SoldierIconOnTouch)(object)UIPackage.CreateObject("LegendItemDungeon", "SoldierIconOnTouch");
	}
	...
	public static UI_SoldierIconOnTouch CreateInstance_ILRuntime()
	{
		...
		UIObjectFactory.SetPackageItemExtension("ui://2eraz3j9jg6431", (GComponentCreator)(() => HotFixManager.Instance.appdomain.Instantiate<GComponent>(full_name, (object[])null)));
