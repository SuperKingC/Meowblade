...
public class UI_MyArrayIndex : GButton
{
	...
	public const string URL = "ui://2eraz3j9ldt62g";

	public static string Name = "UI_MyArrayIndex";

	public static string GetURL()
	{
		return "ui://2eraz3j9ldt62g";
	}

	public static UI_MyArrayIndex CreateInstance()
	{
		return (UI_MyArrayIndex)(object)UIPackage.CreateObject("LegendItemDungeon", "MyArrayIndex");
	}
	...
	public static UI_MyArrayIndex CreateInstance_ILRuntime()
	{
		...
		UIObjectFactory.SetPackageItemExtension("ui://2eraz3j9ldt62g", (GComponentCreator)(() => HotFixManager.Instance.appdomain.Instantiate<GComponent>(full_name, (object[])null)));
	...
	public override void ConstructFromXML(XML xml)
	{
		...
		string id = "ui://2eraz3j9ldt62g".Replace("ui://", "") + "-" + ((GObject)indexText).id;
