...
public class UI_HelpPanel : GComponent
{
	...
	public const string URL = "ui://2eraz3j9j2ox14";

	public static string Name = "UI_HelpPanel";

	public static string GetURL()
	{
		return "ui://2eraz3j9j2ox14";
	}

	public static UI_HelpPanel CreateInstance()
	{
		return (UI_HelpPanel)(object)UIPackage.CreateObject("LegendItemDungeon", "HelpPanel");
	}
	...
	public static UI_HelpPanel CreateInstance_ILRuntime()
	{
		...
		UIObjectFactory.SetPackageItemExtension("ui://2eraz3j9j2ox14", (GComponentCreator)(() => HotFixManager.Instance.appdomain.Instantiate<GComponent>(full_name, (object[])null)));
