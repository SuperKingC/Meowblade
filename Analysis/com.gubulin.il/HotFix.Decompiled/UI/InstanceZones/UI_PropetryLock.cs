...
public class UI_PropetryLock : GButton
{
	...
	public const string URL = "ui://f4wr270rf2586i";

	public static string Name = "UI_PropetryLock";

	public static string GetURL()
	{
		return "ui://f4wr270rf2586i";
	}

	public static UI_PropetryLock CreateInstance()
	{
		return (UI_PropetryLock)(object)UIPackage.CreateObject("InstanceZones", "PropetryLock");
	}
	...
	public static UI_PropetryLock CreateInstance_ILRuntime()
	{
		...
		UIObjectFactory.SetPackageItemExtension("ui://f4wr270rf2586i", (GComponentCreator)(() => HotFixManager.Instance.appdomain.Instantiate<GComponent>(full_name, (object[])null)));
