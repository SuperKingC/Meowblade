...
public class UI_DialogMiddleContent : GComponent
{
	...
	public const string URL = "ui://f4wr270rnr233l";

	public static string Name = "UI_DialogMiddleContent";

	public static string GetURL()
	{
		return "ui://f4wr270rnr233l";
	}

	public static UI_DialogMiddleContent CreateInstance()
	{
		return (UI_DialogMiddleContent)(object)UIPackage.CreateObject("InstanceZones", "DialogMiddleContent");
	}
	...
	public static UI_DialogMiddleContent CreateInstance_ILRuntime()
	{
		...
		UIObjectFactory.SetPackageItemExtension("ui://f4wr270rnr233l", (GComponentCreator)(() => HotFixManager.Instance.appdomain.Instantiate<GComponent>(full_name, (object[])null)));
