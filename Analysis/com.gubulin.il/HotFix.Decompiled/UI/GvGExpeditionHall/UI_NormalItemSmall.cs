...
public class UI_NormalItemSmall : GComponent
{
	...
	public const string URL = "ui://k19peou7x8wj1r";

	public static string Name = "UI_NormalItemSmall";

	public static string GetURL()
	{
		return "ui://k19peou7x8wj1r";
	}

	public static UI_NormalItemSmall CreateInstance()
	{
		return (UI_NormalItemSmall)(object)UIPackage.CreateObject("GvGExpeditionHall", "NormalItemSmall");
	}
	...
	public static UI_NormalItemSmall CreateInstance_ILRuntime()
	{
		...
		UIObjectFactory.SetPackageItemExtension("ui://k19peou7x8wj1r", (GComponentCreator)(() => HotFixManager.Instance.appdomain.Instantiate<GComponent>(full_name, (object[])null)));
