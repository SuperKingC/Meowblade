...
public class UI_com_Message_System : GComponent
{
	...
	public const string URL = "ui://k19peou7dct0p6i";

	public static string Name = "UI_com_Message_System";

	public static string GetURL()
	{
		return "ui://k19peou7dct0p6i";
	}

	public static UI_com_Message_System CreateInstance()
	{
		return (UI_com_Message_System)(object)UIPackage.CreateObject("GvGExpeditionHall", "com_Message_System");
	}
	...
	public static UI_com_Message_System CreateInstance_ILRuntime()
	{
		...
		UIObjectFactory.SetPackageItemExtension("ui://k19peou7dct0p6i", (GComponentCreator)(() => HotFixManager.Instance.appdomain.Instantiate<GComponent>(full_name, (object[])null)));
