...
public class UI_btn_Lock : GButton
{
	...
	public const string URL = "ui://se4hok01fevsr";

	public static string Name = "UI_btn_Lock";

	public static string GetURL()
	{
		return "ui://se4hok01fevsr";
	}

	public static UI_btn_Lock CreateInstance()
	{
		return (UI_btn_Lock)(object)UIPackage.CreateObject("LegendItemBlueprintTemplate", "btn_Lock");
	}
	...
	public static UI_btn_Lock CreateInstance_ILRuntime()
	{
		...
		UIObjectFactory.SetPackageItemExtension("ui://se4hok01fevsr", (GComponentCreator)(() => HotFixManager.Instance.appdomain.Instantiate<GComponent>(full_name, (object[])null)));
