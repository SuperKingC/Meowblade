...
public class UI_com_Propetry : GComponent
{
	...
	public const string URL = "ui://se4hok01wrnf8";

	public static string Name = "UI_com_Propetry";

	public static string GetURL()
	{
		return "ui://se4hok01wrnf8";
	}

	public static UI_com_Propetry CreateInstance()
	{
		return (UI_com_Propetry)(object)UIPackage.CreateObject("LegendItemBlueprintTemplate", "com_Propetry");
	}
	...
	public static UI_com_Propetry CreateInstance_ILRuntime()
	{
		...
		UIObjectFactory.SetPackageItemExtension("ui://se4hok01wrnf8", (GComponentCreator)(() => HotFixManager.Instance.appdomain.Instantiate<GComponent>(full_name, (object[])null)));
