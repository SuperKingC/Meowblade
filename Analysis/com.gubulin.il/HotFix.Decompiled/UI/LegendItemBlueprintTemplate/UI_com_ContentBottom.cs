...
public class UI_com_ContentBottom : GComponent
{
	...
	public const string URL = "ui://se4hok01wrnfg";

	public static string Name = "UI_com_ContentBottom";

	public static string GetURL()
	{
		return "ui://se4hok01wrnfg";
	}

	public static UI_com_ContentBottom CreateInstance()
	{
		return (UI_com_ContentBottom)(object)UIPackage.CreateObject("LegendItemBlueprintTemplate", "com_ContentBottom");
	}
	...
	public static UI_com_ContentBottom CreateInstance_ILRuntime()
	{
		...
		UIObjectFactory.SetPackageItemExtension("ui://se4hok01wrnfg", (GComponentCreator)(() => HotFixManager.Instance.appdomain.Instantiate<GComponent>(full_name, (object[])null)));
