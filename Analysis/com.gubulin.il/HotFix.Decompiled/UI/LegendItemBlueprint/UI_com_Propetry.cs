...
public class UI_com_Propetry : GComponent
{
	...
	public const string URL = "ui://h09dvkcgjpqax";

	public static string Name = "UI_com_Propetry";

	public static string GetURL()
	{
		return "ui://h09dvkcgjpqax";
	}

	public static UI_com_Propetry CreateInstance()
	{
		return (UI_com_Propetry)(object)UIPackage.CreateObject("LegendItemBlueprint", "com_Propetry");
	}
	...
	public static UI_com_Propetry CreateInstance_ILRuntime()
	{
		...
		UIObjectFactory.SetPackageItemExtension("ui://h09dvkcgjpqax", (GComponentCreator)(() => HotFixManager.Instance.appdomain.Instantiate<GComponent>(full_name, (object[])null)));
