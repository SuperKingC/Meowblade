...
public class UI_com_Entries : GComponent
{
	...
	public const string URL = "ui://h09dvkcgjpqa19";

	public static string Name = "UI_com_Entries";

	public static string GetURL()
	{
		return "ui://h09dvkcgjpqa19";
	}

	public static UI_com_Entries CreateInstance()
	{
		return (UI_com_Entries)(object)UIPackage.CreateObject("LegendItemBlueprint", "com_Entries");
	}
	...
	public static UI_com_Entries CreateInstance_ILRuntime()
	{
		...
		UIObjectFactory.SetPackageItemExtension("ui://h09dvkcgjpqa19", (GComponentCreator)(() => HotFixManager.Instance.appdomain.Instantiate<GComponent>(full_name, (object[])null)));
	...
	public override void ConstructFromXML(XML xml)
	{
		...
		string id = "ui://h09dvkcgjpqa19".Replace("ui://", "") + "-" + ((GObject)title0).id;
		((GObject)title0).text = LanguagesManager.GetDesc(id);
		n2 = (GImage)((GComponent)this).GetChild("n2");
		title1 = (GTextField)((GComponent)this).GetChild("title1");
		string id2 = "ui://h09dvkcgjpqa19".Replace("ui://", "") + "-" + ((GObject)title1).id;
		((GObject)title1).text = LanguagesManager.GetDesc(id2);
		n3 = (GTextField)((GComponent)this).GetChild("n3");
		string id3 = "ui://h09dvkcgjpqa19".Replace("ui://", "") + "-" + ((GObject)n3).id;
		((GObject)n3).text = LanguagesManager.GetDesc(id3);
		n4 = (GTextField)((GComponent)this).GetChild("n4");
		string id4 = "ui://h09dvkcgjpqa19".Replace("ui://", "") + "-" + ((GObject)n4).id;
