...
public class UI_SoldierAnimarion : GComponent
{
	...
	public const string URL = "ui://47lbpgx9ef7ej5ltgl";

	public static string Name = "UI_SoldierAnimarion";

	public static string GetURL()
	{
		return "ui://47lbpgx9ef7ej5ltgl";
	}

	public static UI_SoldierAnimarion CreateInstance()
	{
		return (UI_SoldierAnimarion)(object)UIPackage.CreateObject("Tips", "SoldierAnimarion");
	}
	...
	public static UI_SoldierAnimarion CreateInstance_ILRuntime()
	{
		...
		UIObjectFactory.SetPackageItemExtension("ui://47lbpgx9ef7ej5ltgl", (GComponentCreator)(() => HotFixManager.Instance.appdomain.Instantiate<GComponent>(full_name, (object[])null)));
