...
public class UI_UnlockStone : GComponent
{
	...
	public const string URL = "ui://47lbpgx9f15gj5ltgw";

	public static string Name = "UI_UnlockStone";

	public static string GetURL()
	{
		return "ui://47lbpgx9f15gj5ltgw";
	}

	public static UI_UnlockStone CreateInstance()
	{
		return (UI_UnlockStone)(object)UIPackage.CreateObject("Tips", "UnlockStone");
	}
	...
	public static UI_UnlockStone CreateInstance_ILRuntime()
	{
		...
		UIObjectFactory.SetPackageItemExtension("ui://47lbpgx9f15gj5ltgw", (GComponentCreator)(() => HotFixManager.Instance.appdomain.Instantiate<GComponent>(full_name, (object[])null)));
	...
	public override void ConstructFromXML(XML xml)
	{
		...
		string id = "ui://47lbpgx9f15gj5ltgw".Replace("ui://", "") + "-" + ((GObject)num).id;
