...
public class UI_Choice : GButton
{
	...
	public const string URL = "ui://47lbpgx9hvjt3k";

	public static string Name = "UI_Choice";

	public static string GetURL()
	{
		return "ui://47lbpgx9hvjt3k";
	}

	public static UI_Choice CreateInstance()
	{
		return (UI_Choice)(object)UIPackage.CreateObject("Tips", "Choice");
	}
	...
	public static UI_Choice CreateInstance_ILRuntime()
	{
		...
		UIObjectFactory.SetPackageItemExtension("ui://47lbpgx9hvjt3k", (GComponentCreator)(() => HotFixManager.Instance.appdomain.Instantiate<GComponent>(full_name, (object[])null)));
	...
	public override void ConstructFromXML(XML xml)
	{
		...
		string id = "ui://47lbpgx9hvjt3k".Replace("ui://", "") + "-" + ((GObject)title).id;
		((GObject)title).text = LanguagesManager.GetDesc(id);
		introduction = (GRichTextField)((GComponent)this).GetChild("introduction");
		string id2 = "ui://47lbpgx9hvjt3k".Replace("ui://", "") + "-" + ((GObject)introduction).id;
		...
		string id3 = "ui://47lbpgx9hvjt3k".Replace("ui://", "") + "-" + ((GObject)soldierName).id;
