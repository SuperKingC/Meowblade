...
public class UI_SkillBtnOutside : GButton
{
	...
	public const string URL = "ui://47lbpgx9ef7ej5ltgn";

	public static string Name = "UI_SkillBtnOutside";

	public static string GetURL()
	{
		return "ui://47lbpgx9ef7ej5ltgn";
	}

	public static UI_SkillBtnOutside CreateInstance()
	{
		return (UI_SkillBtnOutside)(object)UIPackage.CreateObject("Tips", "SkillBtnOutside");
	}
	...
	public static UI_SkillBtnOutside CreateInstance_ILRuntime()
	{
		...
		UIObjectFactory.SetPackageItemExtension("ui://47lbpgx9ef7ej5ltgn", (GComponentCreator)(() => HotFixManager.Instance.appdomain.Instantiate<GComponent>(full_name, (object[])null)));
