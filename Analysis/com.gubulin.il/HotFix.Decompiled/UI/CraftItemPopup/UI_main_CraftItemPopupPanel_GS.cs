...
public class UI_main_CraftItemPopupPanel_GS : GComponent, IUiController
{
	public GGraph back;
	...
	public const string URL = "ui://4pn38oznqobzlp";

	public static string Name = "UI_main_CraftItemPopupPanel_GS";
	...
	{
		return "ui://4pn38oznqobzlp";
	}

	public static UI_main_CraftItemPopupPanel_GS CreateInstance()
	{
		return (UI_main_CraftItemPopupPanel_GS)(object)UIPackage.CreateObject("CraftItemPopup", "main_CraftItemPopupPanel_GS");
	}

	public static UI_main_CraftItemPopupPanel_GS CreateInstance_ILRuntime()
	{
		//IL_0028: Unknown result type (might be due to invalid IL or missing references)
		//IL_0032: Expected O, but got Unknown
		string full_name = typeof(UI_main_CraftItemPopupPanel_GS).FullName;
		UIObjectFactory.SetPackageItemExtension("ui://4pn38oznqobzlp", (GComponentCreator)(() => HotFixManager.Instance.appdomain.Instantiate<GComponent>(full_name, (object[])null)));
	...
	public void Init(Dictionary<string, object> parameters)
	{
		...
		ItemCount = GameManagers.Instance.StockController.GetStock(ItemId);
