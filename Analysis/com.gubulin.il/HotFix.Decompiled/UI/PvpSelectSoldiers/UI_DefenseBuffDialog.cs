...
public class UI_DefenseBuffDialog : GComponent
{
	public GImage back;
	...
	public const string URL = "ui://82mo10n5qxbi8m";

	public static string Name = "UI_DefenseBuffDialog";

	public static string GetURL()
	{
		return "ui://82mo10n5qxbi8m";
	}

	public static UI_DefenseBuffDialog CreateInstance()
	{
		return (UI_DefenseBuffDialog)(object)UIPackage.CreateObject("PvpSelectSoldiers", "DefenseBuffDialog");
	}

	public static UI_DefenseBuffDialog CreateInstance_ILRuntime()
	{
		//IL_0028: Unknown result type (might be due to invalid IL or missing references)
		//IL_0032: Expected O, but got Unknown
		string full_name = typeof(UI_DefenseBuffDialog).FullName;
		UIObjectFactory.SetPackageItemExtension("ui://82mo10n5qxbi8m", (GComponentCreator)(() => HotFixManager.Instance.appdomain.Instantiate<GComponent>(full_name, (object[])null)));
	...
	public override void ConstructFromXML(XML xml)
	{
		...
		string id = "ui://82mo10n5qxbi8m".Replace("ui://", "") + "-" + ((GObject)tip).id;
