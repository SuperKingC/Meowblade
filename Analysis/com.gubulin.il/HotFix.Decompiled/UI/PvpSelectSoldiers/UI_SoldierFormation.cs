...
public class UI_SoldierFormation : GButton
{
	...
	public const string URL = "ui://82mo10n5vxze5x";

	public static string Name = "UI_SoldierFormation";

	public static string GetURL()
	{
		return "ui://82mo10n5vxze5x";
	}

	public static UI_SoldierFormation CreateInstance()
	{
		return (UI_SoldierFormation)(object)UIPackage.CreateObject("PvpSelectSoldiers", "SoldierFormation");
	}
	...
	public static UI_SoldierFormation CreateInstance_ILRuntime()
	{
		...
		UIObjectFactory.SetPackageItemExtension("ui://82mo10n5vxze5x", (GComponentCreator)(() => HotFixManager.Instance.appdomain.Instantiate<GComponent>(full_name, (object[])null)));
	...
	public override void ConstructFromXML(XML xml)
	{
		...
		string id = "ui://82mo10n5vxze5x".Replace("ui://", "") + "-" + ((GObject)num).id;
