...
public class UI_EnemyInfomationBar : GComponent
{
	...
	public const string URL = "ui://82mo10n5vxze5v";

	public static string Name = "UI_EnemyInfomationBar";

	public static string GetURL()
	{
		return "ui://82mo10n5vxze5v";
	}

	public static UI_EnemyInfomationBar CreateInstance()
	{
		return (UI_EnemyInfomationBar)(object)UIPackage.CreateObject("PvpSelectSoldiers", "EnemyInfomationBar");
	}
	...
	public static UI_EnemyInfomationBar CreateInstance_ILRuntime()
	{
		...
		UIObjectFactory.SetPackageItemExtension("ui://82mo10n5vxze5v", (GComponentCreator)(() => HotFixManager.Instance.appdomain.Instantiate<GComponent>(full_name, (object[])null)));
