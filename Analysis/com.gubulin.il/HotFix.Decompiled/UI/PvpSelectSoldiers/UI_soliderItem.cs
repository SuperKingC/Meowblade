...
public class UI_soliderItem : GButton
{
	...
	public const string URL = "ui://82mo10n5vxze5z";

	public static string Name = "UI_soliderItem";

	public static string GetURL()
	{
		return "ui://82mo10n5vxze5z";
	}

	public static UI_soliderItem CreateInstance()
	{
		return (UI_soliderItem)(object)UIPackage.CreateObject("PvpSelectSoldiers", "soliderItem");
	}
	...
	public static UI_soliderItem CreateInstance_ILRuntime()
	{
		...
		UIObjectFactory.SetPackageItemExtension("ui://82mo10n5vxze5z", (GComponentCreator)(() => HotFixManager.Instance.appdomain.Instantiate<GComponent>(full_name, (object[])null)));
	...
	public override void ConstructFromXML(XML xml)
	{
		...
		string id = "ui://82mo10n5vxze5z".Replace("ui://", "") + "-" + ((GObject)lv).id;
