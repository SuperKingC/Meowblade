...
public class UI_Title : GComponent
{
	...
	public const string URL = "ui://82mo10n5wmk56p";

	public static string Name = "UI_Title";

	public static string GetURL()
	{
		return "ui://82mo10n5wmk56p";
	}

	public static UI_Title CreateInstance()
	{
		return (UI_Title)(object)UIPackage.CreateObject("PvpSelectSoldiers", "Title");
	}
	...
	public static UI_Title CreateInstance_ILRuntime()
	{
		...
		UIObjectFactory.SetPackageItemExtension("ui://82mo10n5wmk56p", (GComponentCreator)(() => HotFixManager.Instance.appdomain.Instantiate<GComponent>(full_name, (object[])null)));
	...
	{
		((GObject)buildingName).text = buildName;
	}
}
