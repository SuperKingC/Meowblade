...
public class UI_btn_FinalTopPlayerNo23 : GButton
{
	...
	public const string URL = "ui://82mo10n5sn0gjdt6";

	public static string Name = "UI_btn_FinalTopPlayerNo23";

	public static string GetURL()
	{
		return "ui://82mo10n5sn0gjdt6";
	}

	public static UI_btn_FinalTopPlayerNo23 CreateInstance()
	{
		return (UI_btn_FinalTopPlayerNo23)(object)UIPackage.CreateObject("PvpSelectSoldiers", "btn_FinalTopPlayerNo23");
	}

	public static UI_btn_FinalTopPlayerNo23 CreateInstance_ILRuntime()
	{
		//IL_0028: Unknown result type (might be due to invalid IL or missing references)
		//IL_0032: Expected O, but got Unknown
		string full_name = typeof(UI_btn_FinalTopPlayerNo23).FullName;
		UIObjectFactory.SetPackageItemExtension("ui://82mo10n5sn0gjdt6", (GComponentCreator)(() => HotFixManager.Instance.appdomain.Instantiate<GComponent>(full_name, (object[])null)));
