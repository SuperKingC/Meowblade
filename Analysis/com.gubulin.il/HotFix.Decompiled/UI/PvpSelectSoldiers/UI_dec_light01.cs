...
public class UI_dec_light01 : GComponent
{
	...
	public const string URL = "ui://82mo10n5hmsjjdta";

	public static string Name = "UI_dec_light01";

	public static string GetURL()
	{
		return "ui://82mo10n5hmsjjdta";
	}

	public static UI_dec_light01 CreateInstance()
	{
		return (UI_dec_light01)(object)UIPackage.CreateObject("PvpSelectSoldiers", "dec_light01");
	}
	...
	public static UI_dec_light01 CreateInstance_ILRuntime()
	{
		...
		UIObjectFactory.SetPackageItemExtension("ui://82mo10n5hmsjjdta", (GComponentCreator)(() => HotFixManager.Instance.appdomain.Instantiate<GComponent>(full_name, (object[])null)));
