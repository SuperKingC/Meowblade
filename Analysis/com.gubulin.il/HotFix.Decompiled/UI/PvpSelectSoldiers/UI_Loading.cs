...
public class UI_Loading : GComponent
{
	...
	public const string URL = "ui://82mo10n5dv2sdax";

	public static string Name = "UI_Loading";

	public static string GetURL()
	{
		return "ui://82mo10n5dv2sdax";
	}

	public static UI_Loading CreateInstance()
	{
		return (UI_Loading)(object)UIPackage.CreateObject("PvpSelectSoldiers", "Loading");
	}
	...
	public static UI_Loading CreateInstance_ILRuntime()
	{
		...
		UIObjectFactory.SetPackageItemExtension("ui://82mo10n5dv2sdax", (GComponentCreator)(() => HotFixManager.Instance.appdomain.Instantiate<GComponent>(full_name, (object[])null)));
