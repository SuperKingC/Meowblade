...
public class UI_SoldierIconOnTouch : GComponent
{
	...
	public const string URL = "ui://82mo10n5gwv064";

	public static string Name = "UI_SoldierIconOnTouch";

	public static string GetURL()
	{
		return "ui://82mo10n5gwv064";
	}

	public static UI_SoldierIconOnTouch CreateInstance()
	{
		return (UI_SoldierIconOnTouch)(object)UIPackage.CreateObject("PvpSelectSoldiers", "SoldierIconOnTouch");
	}
	...
	public static UI_SoldierIconOnTouch CreateInstance_ILRuntime()
	{
		...
		UIObjectFactory.SetPackageItemExtension("ui://82mo10n5gwv064", (GComponentCreator)(() => HotFixManager.Instance.appdomain.Instantiate<GComponent>(full_name, (object[])null)));
