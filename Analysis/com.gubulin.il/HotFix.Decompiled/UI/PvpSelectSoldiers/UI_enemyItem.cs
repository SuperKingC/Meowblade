...
public class UI_enemyItem : GButton
{
	...
	public const string URL = "ui://82mo10n5js4q6w";

	public static string Name = "UI_enemyItem";

	public static string GetURL()
	{
		return "ui://82mo10n5js4q6w";
	}

	public static UI_enemyItem CreateInstance()
	{
		return (UI_enemyItem)(object)UIPackage.CreateObject("PvpSelectSoldiers", "enemyItem");
	}
	...
	public static UI_enemyItem CreateInstance_ILRuntime()
	{
		...
		UIObjectFactory.SetPackageItemExtension("ui://82mo10n5js4q6w", (GComponentCreator)(() => HotFixManager.Instance.appdomain.Instantiate<GComponent>(full_name, (object[])null)));
	...
	public override void ConstructFromXML(XML xml)
	{
		...
		string id = "ui://82mo10n5js4q6w".Replace("ui://", "") + "-" + ((GObject)lv).id;
		((GObject)lv).text = LanguagesManager.GetDesc(id);
		n48 = (GImage)((GComponent)this).GetChild("n48");
		num = (GTextField)((GComponent)this).GetChild("num");
		string id2 = "ui://82mo10n5js4q6w".Replace("ui://", "") + "-" + ((GObject)num).id;
