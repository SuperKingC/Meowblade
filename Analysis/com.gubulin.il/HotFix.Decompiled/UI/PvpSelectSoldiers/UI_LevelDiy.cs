...
public class UI_LevelDiy : GComponent
{
	...
	public const string URL = "ui://82mo10n5qxbi8h";

	public static string Name = "UI_LevelDiy";

	public static string GetURL()
	{
		return "ui://82mo10n5qxbi8h";
	}

	public static UI_LevelDiy CreateInstance()
	{
		return (UI_LevelDiy)(object)UIPackage.CreateObject("PvpSelectSoldiers", "LevelDiy");
	}

	public static UI_LevelDiy CreateInstance_ILRuntime()
	{
		//IL_0028: Unknown result type (might be due to invalid IL or missing references)
		//IL_0032: Expected O, but got Unknown
		string full_name = typeof(UI_LevelDiy).FullName;
		UIObjectFactory.SetPackageItemExtension("ui://82mo10n5qxbi8h", (GComponentCreator)(() => HotFixManager.Instance.appdomain.Instantiate<GComponent>(full_name, (object[])null)));
