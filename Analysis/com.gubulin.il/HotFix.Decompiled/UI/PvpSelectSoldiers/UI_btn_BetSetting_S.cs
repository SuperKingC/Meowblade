...
public class UI_btn_BetSetting_S : GButton
{
	...
	public const string URL = "ui://82mo10n5uwtxjds2";

	public static string Name = "UI_btn_BetSetting_S";

	public static string GetURL()
	{
		return "ui://82mo10n5uwtxjds2";
	}

	public static UI_btn_BetSetting_S CreateInstance()
	{
		return (UI_btn_BetSetting_S)(object)UIPackage.CreateObject("PvpSelectSoldiers", "btn_BetSetting_S");
	}

	public static UI_btn_BetSetting_S CreateInstance_ILRuntime()
	{
		//IL_0028: Unknown result type (might be due to invalid IL or missing references)
		//IL_0032: Expected O, but got Unknown
		string full_name = typeof(UI_btn_BetSetting_S).FullName;
		UIObjectFactory.SetPackageItemExtension("ui://82mo10n5uwtxjds2", (GComponentCreator)(() => HotFixManager.Instance.appdomain.Instantiate<GComponent>(full_name, (object[])null)));
	...
	public override void ConstructFromXML(XML xml)
	{
		...
		string id = "ui://82mo10n5uwtxjds2".Replace("ui://", "") + "-" + ((GObject)title).id;
