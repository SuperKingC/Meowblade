...
public class UI_SkillBtnOutside : GButton
{
	...
	public const string URL = "ui://rn232z3eeohrj2";

	public static string Name = "UI_SkillBtnOutside";

	public static string GetURL()
	{
		return "ui://rn232z3eeohrj2";
	}

	public static UI_SkillBtnOutside CreateInstance()
	{
		return (UI_SkillBtnOutside)(object)UIPackage.CreateObject("EnemyIntroduction", "SkillBtnOutside");
	}
	...
	public static UI_SkillBtnOutside CreateInstance_ILRuntime()
	{
		...
		UIObjectFactory.SetPackageItemExtension("ui://rn232z3eeohrj2", (GComponentCreator)(() => HotFixManager.Instance.appdomain.Instantiate<GComponent>(full_name, (object[])null)));
