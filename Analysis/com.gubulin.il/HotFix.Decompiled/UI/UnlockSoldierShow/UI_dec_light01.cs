...
public class UI_dec_light01 : GComponent
{
	...
	public const string URL = "ui://ia1am3ehi7qut35";

	public static string Name = "UI_dec_light01";

	public static string GetURL()
	{
		return "ui://ia1am3ehi7qut35";
	}

	public static UI_dec_light01 CreateInstance()
	{
		return (UI_dec_light01)(object)UIPackage.CreateObject("UnlockSoldierShow", "dec_light01");
	}
	...
	public static UI_dec_light01 CreateInstance_ILRuntime()
	{
		...
		UIObjectFactory.SetPackageItemExtension("ui://ia1am3ehi7qut35", (GComponentCreator)(() => HotFixManager.Instance.appdomain.Instantiate<GComponent>(full_name, (object[])null)));
