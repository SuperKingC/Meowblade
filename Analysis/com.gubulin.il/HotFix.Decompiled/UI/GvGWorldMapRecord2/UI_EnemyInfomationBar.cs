...
public class UI_EnemyInfomationBar : GComponent
{
	...
	public const string URL = "ui://5xc1njmujjrn2b";

	public static string Name = "UI_EnemyInfomationBar";

	public static string GetURL()
	{
		return "ui://5xc1njmujjrn2b";
	}

	public static UI_EnemyInfomationBar CreateInstance()
	{
		return (UI_EnemyInfomationBar)(object)UIPackage.CreateObject("GvGWorldMapRecord2", "EnemyInfomationBar");
	}
	...
	public static UI_EnemyInfomationBar CreateInstance_ILRuntime()
	{
		...
		UIObjectFactory.SetPackageItemExtension("ui://5xc1njmujjrn2b", (GComponentCreator)(() => HotFixManager.Instance.appdomain.Instantiate<GComponent>(full_name, (object[])null)));
