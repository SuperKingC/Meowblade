...
public class UI_MyArrayIndex : GButton
{
	...
	public const string URL = "ui://5xc1njmujjrn2q";

	public static string Name = "UI_MyArrayIndex";

	public static string GetURL()
	{
		return "ui://5xc1njmujjrn2q";
	}

	public static UI_MyArrayIndex CreateInstance()
	{
		return (UI_MyArrayIndex)(object)UIPackage.CreateObject("GvGWorldMapRecord2", "MyArrayIndex");
	}
	...
	public static UI_MyArrayIndex CreateInstance_ILRuntime()
	{
		...
		UIObjectFactory.SetPackageItemExtension("ui://5xc1njmujjrn2q", (GComponentCreator)(() => HotFixManager.Instance.appdomain.Instantiate<GComponent>(full_name, (object[])null)));
	...
	public override void ConstructFromXML(XML xml)
	{
		...
		string id = "ui://5xc1njmujjrn2q".Replace("ui://", "") + "-" + ((GObject)indexText).id;
