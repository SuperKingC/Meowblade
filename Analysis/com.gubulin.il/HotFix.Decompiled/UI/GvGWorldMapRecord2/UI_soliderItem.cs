...
public class UI_soliderItem : GButton
{
	...
	public const string URL = "ui://5xc1njmujjrn2g";

	public static string Name = "UI_soliderItem";

	public static string GetURL()
	{
		return "ui://5xc1njmujjrn2g";
	}

	public static UI_soliderItem CreateInstance()
	{
		return (UI_soliderItem)(object)UIPackage.CreateObject("GvGWorldMapRecord2", "soliderItem");
	}
	...
	public static UI_soliderItem CreateInstance_ILRuntime()
	{
		...
		UIObjectFactory.SetPackageItemExtension("ui://5xc1njmujjrn2g", (GComponentCreator)(() => HotFixManager.Instance.appdomain.Instantiate<GComponent>(full_name, (object[])null)));
	...
	public override void ConstructFromXML(XML xml)
	{
		...
		string id = "ui://5xc1njmujjrn2g".Replace("ui://", "") + "-" + ((GObject)lv).id;
