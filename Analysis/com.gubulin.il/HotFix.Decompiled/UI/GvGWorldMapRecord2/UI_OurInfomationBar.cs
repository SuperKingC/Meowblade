...
public class UI_OurInfomationBar : GComponent
{
	...
	public const string URL = "ui://5xc1njmujjrn24";

	public static string Name = "UI_OurInfomationBar";

	public static string GetURL()
	{
		return "ui://5xc1njmujjrn24";
	}

	public static UI_OurInfomationBar CreateInstance()
	{
		return (UI_OurInfomationBar)(object)UIPackage.CreateObject("GvGWorldMapRecord2", "OurInfomationBar");
	}
	...
	public static UI_OurInfomationBar CreateInstance_ILRuntime()
	{
		...
		UIObjectFactory.SetPackageItemExtension("ui://5xc1njmujjrn24", (GComponentCreator)(() => HotFixManager.Instance.appdomain.Instantiate<GComponent>(full_name, (object[])null)));
