...
public class UI_SoldierFormation : GButton
{
	...
	public const string URL = "ui://5xc1njmujjrn2f";

	public static string Name = "UI_SoldierFormation";

	public static string GetURL()
	{
		return "ui://5xc1njmujjrn2f";
	}

	public static UI_SoldierFormation CreateInstance()
	{
		return (UI_SoldierFormation)(object)UIPackage.CreateObject("GvGWorldMapRecord2", "SoldierFormation");
	}
	...
	public static UI_SoldierFormation CreateInstance_ILRuntime()
	{
		...
		UIObjectFactory.SetPackageItemExtension("ui://5xc1njmujjrn2f", (GComponentCreator)(() => HotFixManager.Instance.appdomain.Instantiate<GComponent>(full_name, (object[])null)));
	...
	public override void ConstructFromXML(XML xml)
	{
		...
		string id = "ui://5xc1njmujjrn2f".Replace("ui://", "") + "-" + ((GObject)num).id;
