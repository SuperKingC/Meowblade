...
public class UI_show : GButton
{
	...
	public const string URL = "ui://5xc1njmuqyk93f";

	public static string Name = "UI_show";

	public static string GetURL()
	{
		return "ui://5xc1njmuqyk93f";
	}

	public static UI_show CreateInstance()
	{
		return (UI_show)(object)UIPackage.CreateObject("GvGWorldMapRecord2", "show");
	}
	...
	public static UI_show CreateInstance_ILRuntime()
	{
		...
		UIObjectFactory.SetPackageItemExtension("ui://5xc1njmuqyk93f", (GComponentCreator)(() => HotFixManager.Instance.appdomain.Instantiate<GComponent>(full_name, (object[])null)));
