...
public class UI_GvGBattleRecordsDialog : GComponent
{
	...
	public const string URL = "ui://5xc1njmujjrn2x";

	public static string Name = "UI_GvGBattleRecordsDialog";

	public static string GetURL()
	{
		return "ui://5xc1njmujjrn2x";
	}

	public static UI_GvGBattleRecordsDialog CreateInstance()
	{
		return (UI_GvGBattleRecordsDialog)(object)UIPackage.CreateObject("GvGWorldMapRecord2", "GvGBattleRecordsDialog");
	}
	...
	public static UI_GvGBattleRecordsDialog CreateInstance_ILRuntime()
	{
		...
		UIObjectFactory.SetPackageItemExtension("ui://5xc1njmujjrn2x", (GComponentCreator)(() => HotFixManager.Instance.appdomain.Instantiate<GComponent>(full_name, (object[])null)));
