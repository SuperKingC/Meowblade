...
public class UI_CardLoader : GComponent
{
	...
	public const string URL = "ui://4pzrvwm6l1asa";

	public static string Name = "UI_CardLoader";

	public static string GetURL()
	{
		return "ui://4pzrvwm6l1asa";
	}

	public static UI_CardLoader CreateInstance()
	{
		return (UI_CardLoader)(object)UIPackage.CreateObject("MtgGiftPacks", "CardLoader");
	}
	...
	public static UI_CardLoader CreateInstance_ILRuntime()
	{
		...
		UIObjectFactory.SetPackageItemExtension("ui://4pzrvwm6l1asa", (GComponentCreator)(() => HotFixManager.Instance.appdomain.Instantiate<GComponent>(full_name, (object[])null)));
