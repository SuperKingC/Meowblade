...
public class UI_ForestMist : GButton
{
	public GImage mask;
	...
	public UI_ForestMist_1Btn stronghold5;
	...
	public UI_ForestMist_2Btn stronghold10;
	...
	public UI_ForestMist_3Btn stronghold15;
	...
	public UI_ForestMist_4Btn stronghold20;
	...
	public const string URL = "ui://c9n2h0ksm7wz9k";

	public static string Name = "UI_ForestMist";

	public static string GetURL()
	{
		return "ui://c9n2h0ksm7wz9k";
	}

	public static UI_ForestMist CreateInstance()
	{
		return (UI_ForestMist)(object)UIPackage.CreateObject("WorldMap", "ForestMist");
	}

	public static UI_ForestMist CreateInstance_ILRuntime()
	{
		//IL_0028: Unknown result type (might be due to invalid IL or missing references)
		//IL_0032: Expected O, but got Unknown
		string full_name = typeof(UI_ForestMist).FullName;
		UIObjectFactory.SetPackageItemExtension("ui://c9n2h0ksm7wz9k", (GComponentCreator)(() => HotFixManager.Instance.appdomain.Instantiate<GComponent>(full_name, (object[])null)));
	...
	public override void ConstructFromXML(XML xml)
	{
		...
		string id = "ui://c9n2h0ksm7wz9k".Replace("ui://", "") + "-" + ((GObject)levelName).id;
		...
		stronghold5 = (UI_ForestMist_1Btn)(object)((GComponent)this).GetChild("stronghold5");
		...
		stronghold10 = (UI_ForestMist_2Btn)(object)((GComponent)this).GetChild("stronghold10");
		...
		stronghold15 = (UI_ForestMist_3Btn)(object)((GComponent)this).GetChild("stronghold15");
		...
		stronghold20 = (UI_ForestMist_4Btn)(object)((GComponent)this).GetChild("stronghold20");
		...
		slot3 = (GGraph)((GComponent)this).GetChild("slot3");
