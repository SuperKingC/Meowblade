...
public class UI_KeelField : GButton
{
	public GImage mask;
	...
	public UI_KeelField_1Btn stronghold5;
	...
	public UI_KeelField_2Btn stronghold10;
	...
	public UI_KeelField_3Btn stronghold15;
	...
	public UI_KeelField_4Btn stronghold20;
	...
	public const string URL = "ui://c9n2h0ksm7wz9o";

	public static string Name = "UI_KeelField";

	public static string GetURL()
	{
		return "ui://c9n2h0ksm7wz9o";
	}

	public static UI_KeelField CreateInstance()
	{
		return (UI_KeelField)(object)UIPackage.CreateObject("WorldMap", "KeelField");
	}

	public static UI_KeelField CreateInstance_ILRuntime()
	{
		//IL_0028: Unknown result type (might be due to invalid IL or missing references)
		//IL_0032: Expected O, but got Unknown
		string full_name = typeof(UI_KeelField).FullName;
		UIObjectFactory.SetPackageItemExtension("ui://c9n2h0ksm7wz9o", (GComponentCreator)(() => HotFixManager.Instance.appdomain.Instantiate<GComponent>(full_name, (object[])null)));
	...
	public override void ConstructFromXML(XML xml)
	{
		...
		stronghold5 = (UI_KeelField_1Btn)(object)((GComponent)this).GetChild("stronghold5");
		...
		stronghold10 = (UI_KeelField_2Btn)(object)((GComponent)this).GetChild("stronghold10");
		...
		stronghold15 = (UI_KeelField_3Btn)(object)((GComponent)this).GetChild("stronghold15");
		...
		stronghold20 = (UI_KeelField_4Btn)(object)((GComponent)this).GetChild("stronghold20");
