...
public class UI_CloudsShadow : GComponent
{
	...
	public const string URL = "ui://c9n2h0ksm7wz9f";

	public static string Name = "UI_CloudsShadow";

	public static string GetURL()
	{
		return "ui://c9n2h0ksm7wz9f";
	}

	public static UI_CloudsShadow CreateInstance()
	{
		return (UI_CloudsShadow)(object)UIPackage.CreateObject("WorldMap", "CloudsShadow");
	}

	public static UI_CloudsShadow CreateInstance_ILRuntime()
	{
		//IL_0028: Unknown result type (might be due to invalid IL or missing references)
		//IL_0032: Expected O, but got Unknown
		string full_name = typeof(UI_CloudsShadow).FullName;
		UIObjectFactory.SetPackageItemExtension("ui://c9n2h0ksm7wz9f", (GComponentCreator)(() => HotFixManager.Instance.appdomain.Instantiate<GComponent>(full_name, (object[])null)));
