...
public class UI_ImpasseFortress : GButton
{
	public GImage mask;
	...
	public const string URL = "ui://c9n2h0ksm7wz9m";

	public static string Name = "UI_ImpasseFortress";

	public static string GetURL()
	{
		return "ui://c9n2h0ksm7wz9m";
	}

	public static UI_ImpasseFortress CreateInstance()
	{
		return (UI_ImpasseFortress)(object)UIPackage.CreateObject("WorldMap", "ImpasseFortress");
	}

	public static UI_ImpasseFortress CreateInstance_ILRuntime()
	{
		//IL_0028: Unknown result type (might be due to invalid IL or missing references)
		//IL_0032: Expected O, but got Unknown
		string full_name = typeof(UI_ImpasseFortress).FullName;
		UIObjectFactory.SetPackageItemExtension("ui://c9n2h0ksm7wz9m", (GComponentCreator)(() => HotFixManager.Instance.appdomain.Instantiate<GComponent>(full_name, (object[])null)));
