...
public class UI_Unknown2 : GButton
{
	public GImage mask;
	...
	public const string URL = "ui://c9n2h0ksm7wz9y";

	public static string Name = "UI_Unknown2";

	public static string GetURL()
	{
		return "ui://c9n2h0ksm7wz9y";
	}

	public static UI_Unknown2 CreateInstance()
	{
		return (UI_Unknown2)(object)UIPackage.CreateObject("WorldMap", "Unknown2");
	}

	public static UI_Unknown2 CreateInstance_ILRuntime()
	{
		//IL_0028: Unknown result type (might be due to invalid IL or missing references)
		//IL_0032: Expected O, but got Unknown
		string full_name = typeof(UI_Unknown2).FullName;
		UIObjectFactory.SetPackageItemExtension("ui://c9n2h0ksm7wz9y", (GComponentCreator)(() => HotFixManager.Instance.appdomain.Instantiate<GComponent>(full_name, (object[])null)));
