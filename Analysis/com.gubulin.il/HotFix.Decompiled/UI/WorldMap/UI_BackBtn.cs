...
public class UI_BackBtn : GButton
{
	...
	public const string URL = "ui://c9n2h0ksaxr6jz";

	public static string Name = "UI_BackBtn";

	public static string GetURL()
	{
		return "ui://c9n2h0ksaxr6jz";
	}

	public static UI_BackBtn CreateInstance()
	{
		return (UI_BackBtn)(object)UIPackage.CreateObject("WorldMap", "BackBtn");
	}
	...
	public static UI_BackBtn CreateInstance_ILRuntime()
	{
		...
		UIObjectFactory.SetPackageItemExtension("ui://c9n2h0ksaxr6jz", (GComponentCreator)(() => HotFixManager.Instance.appdomain.Instantiate<GComponent>(full_name, (object[])null)));
