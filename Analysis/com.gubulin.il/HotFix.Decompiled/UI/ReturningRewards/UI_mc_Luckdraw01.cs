...
public class UI_mc_Luckdraw01 : GComponent
{
	...
	public const string URL = "ui://rx5ntv98kaq5z";

	public static string Name = "UI_mc_Luckdraw01";

	public static string GetURL()
	{
		return "ui://rx5ntv98kaq5z";
	}

	public static UI_mc_Luckdraw01 CreateInstance()
	{
		return (UI_mc_Luckdraw01)(object)UIPackage.CreateObject("ReturningRewards", "mc_Luckdraw01");
	}
	...
	public static UI_mc_Luckdraw01 CreateInstance_ILRuntime()
	{
		...
		UIObjectFactory.SetPackageItemExtension("ui://rx5ntv98kaq5z", (GComponentCreator)(() => HotFixManager.Instance.appdomain.Instantiate<GComponent>(full_name, (object[])null)));
