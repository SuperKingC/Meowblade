...
public class UI_DialogMiddleContent : GComponent
{
	...
	public const string URL = "ui://5mgjx17ngb514";

	public static string Name = "UI_DialogMiddleContent";

	public static string GetURL()
	{
		return "ui://5mgjx17ngb514";
	}

	public static UI_DialogMiddleContent CreateInstance()
	{
		return (UI_DialogMiddleContent)(object)UIPackage.CreateObject("Restart", "DialogMiddleContent");
	}
	...
	public static UI_DialogMiddleContent CreateInstance_ILRuntime()
	{
		...
		UIObjectFactory.SetPackageItemExtension("ui://5mgjx17ngb514", (GComponentCreator)(() => HotFixManager.Instance.appdomain.Instantiate<GComponent>(full_name, (object[])null)));
