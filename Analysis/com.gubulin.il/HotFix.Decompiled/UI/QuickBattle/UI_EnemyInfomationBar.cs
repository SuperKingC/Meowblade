...
public class UI_EnemyInfomationBar : GComponent
{
	...
	public const string URL = "ui://kqd1t06of258c";

	public static string Name = "UI_EnemyInfomationBar";

	public static string GetURL()
	{
		return "ui://kqd1t06of258c";
	}

	public static UI_EnemyInfomationBar CreateInstance()
	{
		return (UI_EnemyInfomationBar)(object)UIPackage.CreateObject("QuickBattle", "EnemyInfomationBar");
	}
	...
	public static UI_EnemyInfomationBar CreateInstance_ILRuntime()
	{
		...
		UIObjectFactory.SetPackageItemExtension("ui://kqd1t06of258c", (GComponentCreator)(() => HotFixManager.Instance.appdomain.Instantiate<GComponent>(full_name, (object[])null)));
	...
	public override void ConstructFromXML(XML xml)
	{
		...
		string id = "ui://kqd1t06of258c".Replace("ui://", "") + "-" + ((GObject)ArmyGroupName).id;
