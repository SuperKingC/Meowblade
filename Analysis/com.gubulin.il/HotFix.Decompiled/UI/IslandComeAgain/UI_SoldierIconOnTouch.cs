...
public class UI_SoldierIconOnTouch : GComponent
{
	...
	public const string URL = "ui://k2sprg26zoyk3g";

	public static string Name = "UI_SoldierIconOnTouch";

	public static string GetURL()
	{
		return "ui://k2sprg26zoyk3g";
	}

	public static UI_SoldierIconOnTouch CreateInstance()
	{
		return (UI_SoldierIconOnTouch)(object)UIPackage.CreateObject("IslandComeAgain", "SoldierIconOnTouch");
	}
	...
	public static UI_SoldierIconOnTouch CreateInstance_ILRuntime()
	{
		...
		UIObjectFactory.SetPackageItemExtension("ui://k2sprg26zoyk3g", (GComponentCreator)(() => HotFixManager.Instance.appdomain.Instantiate<GComponent>(full_name, (object[])null)));
