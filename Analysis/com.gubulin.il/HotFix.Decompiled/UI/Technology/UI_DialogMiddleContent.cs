...
public class UI_DialogMiddleContent : GComponent
{
	...
	public const string URL = "ui://7ca77a3fnwky3m";

	public static string Name = "UI_DialogMiddleContent";

	public static string GetURL()
	{
		return "ui://7ca77a3fnwky3m";
	}

	public static UI_DialogMiddleContent CreateInstance()
	{
		return (UI_DialogMiddleContent)(object)UIPackage.CreateObject("Technology", "DialogMiddleContent");
	}
	...
	public static UI_DialogMiddleContent CreateInstance_ILRuntime()
	{
		...
		UIObjectFactory.SetPackageItemExtension("ui://7ca77a3fnwky3m", (GComponentCreator)(() => HotFixManager.Instance.appdomain.Instantiate<GComponent>(full_name, (object[])null)));
