...
public class UI_Title : GComponent
{
	...
	public const string URL = "ui://7ca77a3flh3u32";

	public static string Name = "UI_Title";

	public static string GetURL()
	{
		return "ui://7ca77a3flh3u32";
	}

	public static UI_Title CreateInstance()
	{
		return (UI_Title)(object)UIPackage.CreateObject("Technology", "Title");
	}
	...
	public static UI_Title CreateInstance_ILRuntime()
	{
		...
		UIObjectFactory.SetPackageItemExtension("ui://7ca77a3flh3u32", (GComponentCreator)(() => HotFixManager.Instance.appdomain.Instantiate<GComponent>(full_name, (object[])null)));
