...
public class UI_dec_Particleeffect : GComponent
{
	...
	public const string URL = "ui://6ccguk4firuh3";

	public static string Name = "UI_dec_Particleeffect";

	public static string GetURL()
	{
		return "ui://6ccguk4firuh3";
	}

	public static UI_dec_Particleeffect CreateInstance()
	{
		return (UI_dec_Particleeffect)(object)UIPackage.CreateObject("GvG3StoreEntrance", "dec_Particleeffect");
	}
	...
	public static UI_dec_Particleeffect CreateInstance_ILRuntime()
	{
		...
		UIObjectFactory.SetPackageItemExtension("ui://6ccguk4firuh3", (GComponentCreator)(() => HotFixManager.Instance.appdomain.Instantiate<GComponent>(full_name, (object[])null)));
