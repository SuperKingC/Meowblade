...
public class UI_dec_Particleeffect2 : GComponent
{
	...
	public const string URL = "ui://6ccguk4firuh8";

	public static string Name = "UI_dec_Particleeffect2";

	public static string GetURL()
	{
		return "ui://6ccguk4firuh8";
	}

	public static UI_dec_Particleeffect2 CreateInstance()
	{
		return (UI_dec_Particleeffect2)(object)UIPackage.CreateObject("GvG3StoreEntrance", "dec_Particleeffect2");
	}
	...
	public static UI_dec_Particleeffect2 CreateInstance_ILRuntime()
	{
		...
		UIObjectFactory.SetPackageItemExtension("ui://6ccguk4firuh8", (GComponentCreator)(() => HotFixManager.Instance.appdomain.Instantiate<GComponent>(full_name, (object[])null)));
