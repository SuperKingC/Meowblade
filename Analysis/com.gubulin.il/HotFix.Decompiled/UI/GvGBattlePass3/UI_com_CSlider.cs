...
public class UI_com_CSlider : GComponent
{
	...
	public const string URL = "ui://bfjg32huq1eq3d";
	...
	{
		return "ui://bfjg32huq1eq3d";
	}

	public static UI_com_CSlider CreateInstance()
	{
		return (UI_com_CSlider)(object)UIPackage.CreateObject("GvGBattlePass3", "com_CSlider");
	}
	...
	public static UI_com_CSlider CreateInstance_ILRuntime()
	{
		...
		UIObjectFactory.SetPackageItemExtension("ui://bfjg32huq1eq3d", (GComponentCreator)(() => HotFixManager.Instance.appdomain.Instantiate<GComponent>(full_name, (object[])null)));
