...
public class UI_SkillBtnOutside : GButton
{
	...
	public const string URL = "ui://jctgkd2urxdc4";

	public static string Name = "UI_SkillBtnOutside";

	public static string GetURL()
	{
		return "ui://jctgkd2urxdc4";
	}

	public static UI_SkillBtnOutside CreateInstance()
	{
		return (UI_SkillBtnOutside)(object)UIPackage.CreateObject("UnlockSoldierInfo", "SkillBtnOutside");
	}
	...
	public static UI_SkillBtnOutside CreateInstance_ILRuntime()
	{
		...
		UIObjectFactory.SetPackageItemExtension("ui://jctgkd2urxdc4", (GComponentCreator)(() => HotFixManager.Instance.appdomain.Instantiate<GComponent>(full_name, (object[])null)));
