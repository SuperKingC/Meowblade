...
public class UI_SoldierAnimarion : GComponent
{
	...
	public const string URL = "ui://jctgkd2urxdc2";

	public static string Name = "UI_SoldierAnimarion";

	public static string GetURL()
	{
		return "ui://jctgkd2urxdc2";
	}

	public static UI_SoldierAnimarion CreateInstance()
	{
		return (UI_SoldierAnimarion)(object)UIPackage.CreateObject("UnlockSoldierInfo", "SoldierAnimarion");
	}
	...
	public static UI_SoldierAnimarion CreateInstance_ILRuntime()
	{
		...
		UIObjectFactory.SetPackageItemExtension("ui://jctgkd2urxdc2", (GComponentCreator)(() => HotFixManager.Instance.appdomain.Instantiate<GComponent>(full_name, (object[])null)));
