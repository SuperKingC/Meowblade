...
public class UI_SoldierSelectionBtn : GButton
{
	...
	public const string URL = "ui://fwpu3639b4vaf";

	public static string Name = "UI_SoldierSelectionBtn";

	public static string GetURL()
	{
		return "ui://fwpu3639b4vaf";
	}

	public static UI_SoldierSelectionBtn CreateInstance()
	{
		return (UI_SoldierSelectionBtn)(object)UIPackage.CreateObject("GvGAmplifierStorage", "SoldierSelectionBtn");
	}
	...
	public static UI_SoldierSelectionBtn CreateInstance_ILRuntime()
	{
		...
		UIObjectFactory.SetPackageItemExtension("ui://fwpu3639b4vaf", (GComponentCreator)(() => HotFixManager.Instance.appdomain.Instantiate<GComponent>(full_name, (object[])null)));
