...
public class UI_com_Title : GComponent
{
	...
	public const string URL = "ui://fwpu3639b4va1";

	public static string Name = "UI_com_Title";

	public static string GetURL()
	{
		return "ui://fwpu3639b4va1";
	}

	public static UI_com_Title CreateInstance()
	{
		return (UI_com_Title)(object)UIPackage.CreateObject("GvGAmplifierStorage", "com_Title");
	}
	...
	public static UI_com_Title CreateInstance_ILRuntime()
	{
		...
		UIObjectFactory.SetPackageItemExtension("ui://fwpu3639b4va1", (GComponentCreator)(() => HotFixManager.Instance.appdomain.Instantiate<GComponent>(full_name, (object[])null)));
	...
	public override void ConstructFromXML(XML xml)
	{
		...
		string id = "ui://fwpu3639b4va1".Replace("ui://", "") + "-" + ((GObject)buildingName).id;
