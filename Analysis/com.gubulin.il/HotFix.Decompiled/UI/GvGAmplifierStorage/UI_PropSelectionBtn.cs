...
public class UI_PropSelectionBtn : GButton
{
	...
	public const string URL = "ui://fwpu3639q8fuo";

	public static string Name = "UI_PropSelectionBtn";

	public static string GetURL()
	{
		return "ui://fwpu3639q8fuo";
	}

	public static UI_PropSelectionBtn CreateInstance()
	{
		return (UI_PropSelectionBtn)(object)UIPackage.CreateObject("GvGAmplifierStorage", "PropSelectionBtn");
	}
	...
	public static UI_PropSelectionBtn CreateInstance_ILRuntime()
	{
		...
		UIObjectFactory.SetPackageItemExtension("ui://fwpu3639q8fuo", (GComponentCreator)(() => HotFixManager.Instance.appdomain.Instantiate<GComponent>(full_name, (object[])null)));
