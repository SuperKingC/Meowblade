...
public class UI_QualitySelectionBtn : GButton
{
	...
	public const string URL = "ui://fwpu3639b4va6";

	public static string Name = "UI_QualitySelectionBtn";

	public static string GetURL()
	{
		return "ui://fwpu3639b4va6";
	}

	public static UI_QualitySelectionBtn CreateInstance()
	{
		return (UI_QualitySelectionBtn)(object)UIPackage.CreateObject("GvGAmplifierStorage", "QualitySelectionBtn");
	}
	...
	public static UI_QualitySelectionBtn CreateInstance_ILRuntime()
	{
		...
		UIObjectFactory.SetPackageItemExtension("ui://fwpu3639b4va6", (GComponentCreator)(() => HotFixManager.Instance.appdomain.Instantiate<GComponent>(full_name, (object[])null)));
