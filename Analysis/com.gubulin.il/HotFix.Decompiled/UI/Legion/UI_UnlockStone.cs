...
public class UI_UnlockStone : GComponent
{
	...
	public const string URL = "ui://lrhs6zw7f4sz454";

	public static string Name = "UI_UnlockStone";

	public static string GetURL()
	{
		return "ui://lrhs6zw7f4sz454";
	}

	public static UI_UnlockStone CreateInstance()
	{
		return (UI_UnlockStone)(object)UIPackage.CreateObject("Legion", "UnlockStone");
	}
	...
	public static UI_UnlockStone CreateInstance_ILRuntime()
	{
		...
		UIObjectFactory.SetPackageItemExtension("ui://lrhs6zw7f4sz454", (GComponentCreator)(() => HotFixManager.Instance.appdomain.Instantiate<GComponent>(full_name, (object[])null)));
	...
	public override void ConstructFromXML(XML xml)
	{
		...
		string id = "ui://lrhs6zw7f4sz454".Replace("ui://", "") + "-" + ((GObject)num).id;
