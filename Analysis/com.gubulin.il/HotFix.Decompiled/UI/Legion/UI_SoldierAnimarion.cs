...
public class UI_SoldierAnimarion : GComponent
{
	...
	public const string URL = "ui://lrhs6zw7ocw145m";

	public static string Name = "UI_SoldierAnimarion";

	public static string GetURL()
	{
		return "ui://lrhs6zw7ocw145m";
	}

	public static UI_SoldierAnimarion CreateInstance()
	{
		return (UI_SoldierAnimarion)(object)UIPackage.CreateObject("Legion", "SoldierAnimarion");
	}
	...
	public static UI_SoldierAnimarion CreateInstance_ILRuntime()
	{
		...
		UIObjectFactory.SetPackageItemExtension("ui://lrhs6zw7ocw145m", (GComponentCreator)(() => HotFixManager.Instance.appdomain.Instantiate<GComponent>(full_name, (object[])null)));
