...
public class UI_btn_RewardType : GButton
{
	...
	public const string URL = "ui://hozu168rniiv69";

	public static string Name = "UI_btn_RewardType";

	public static string GetURL()
	{
		return "ui://hozu168rniiv69";
	}

	public static UI_btn_RewardType CreateInstance()
	{
		return (UI_btn_RewardType)(object)UIPackage.CreateObject("GvGBrawlFight", "btn_RewardType");
	}
	...
	public static UI_btn_RewardType CreateInstance_ILRuntime()
	{
		...
		UIObjectFactory.SetPackageItemExtension("ui://hozu168rniiv69", (GComponentCreator)(() => HotFixManager.Instance.appdomain.Instantiate<GComponent>(full_name, (object[])null)));
	...
	public override void ConstructFromXML(XML xml)
	{
		...
		string id = "ui://hozu168rniiv69".Replace("ui://", "") + "-" + ((GObject)n4).id;
		((GObject)n4).text = LanguagesManager.GetDesc(id);
		n5 = (GTextField)((GComponent)this).GetChild("n5");
		string id2 = "ui://hozu168rniiv69".Replace("ui://", "") + "-" + ((GObject)n5).id;
		((GObject)n5).text = LanguagesManager.GetDesc(id2);
		n6 = (GTextField)((GComponent)this).GetChild("n6");
		string id3 = "ui://hozu168rniiv69".Replace("ui://", "") + "-" + ((GObject)n6).id;
