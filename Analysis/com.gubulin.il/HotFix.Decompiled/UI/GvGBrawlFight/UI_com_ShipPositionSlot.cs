...
public class UI_com_ShipPositionSlot : GComponent, IShipPosition
{
	...
	public UI_com_IslandAvatar avatar;
	...
	public const string URL = "ui://hozu168rnt90d";

	public static string Name = "UI_com_ShipPositionSlot";
	...
	{
		return "ui://hozu168rnt90d";
	}

	public static UI_com_ShipPositionSlot CreateInstance()
	{
		return (UI_com_ShipPositionSlot)(object)UIPackage.CreateObject("GvGBrawlFight", "com_ShipPositionSlot");
	}

	public static UI_com_ShipPositionSlot CreateInstance_ILRuntime()
	{
		//IL_0028: Unknown result type (might be due to invalid IL or missing references)
		//IL_0032: Expected O, but got Unknown
		string full_name = typeof(UI_com_ShipPositionSlot).FullName;
		UIObjectFactory.SetPackageItemExtension("ui://hozu168rnt90d", (GComponentCreator)(() => HotFixManager.Instance.appdomain.Instantiate<GComponent>(full_name, (object[])null)));
	...
	public override void ConstructFromXML(XML xml)
	{
		...
		avatar = (UI_com_IslandAvatar)(object)((GComponent)this).GetChild("avatar");
