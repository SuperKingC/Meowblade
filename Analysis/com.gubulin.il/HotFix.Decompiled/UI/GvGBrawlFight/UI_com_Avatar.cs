...
public class UI_com_Avatar : GComponent
{
	...
	public const string URL = "ui://hozu168rzbfu2z";

	public static string Name = "UI_com_Avatar";

	public static string GetURL()
	{
		return "ui://hozu168rzbfu2z";
	}

	public static UI_com_Avatar CreateInstance()
	{
		return (UI_com_Avatar)(object)UIPackage.CreateObject("GvGBrawlFight", "com_Avatar");
	}
	...
	public static UI_com_Avatar CreateInstance_ILRuntime()
	{
		...
		UIObjectFactory.SetPackageItemExtension("ui://hozu168rzbfu2z", (GComponentCreator)(() => HotFixManager.Instance.appdomain.Instantiate<GComponent>(full_name, (object[])null)));
