...
public class UI_btn_04 : GButton
{
	...
	public const string URL = "ui://hozu168rq3fm62";

	public static string Name = "UI_btn_04";

	public static string GetURL()
	{
		return "ui://hozu168rq3fm62";
	}

	public static UI_btn_04 CreateInstance()
	{
		return (UI_btn_04)(object)UIPackage.CreateObject("GvGBrawlFight", "btn_04");
	}
	...
	public static UI_btn_04 CreateInstance_ILRuntime()
	{
		...
		UIObjectFactory.SetPackageItemExtension("ui://hozu168rq3fm62", (GComponentCreator)(() => HotFixManager.Instance.appdomain.Instantiate<GComponent>(full_name, (object[])null)));
