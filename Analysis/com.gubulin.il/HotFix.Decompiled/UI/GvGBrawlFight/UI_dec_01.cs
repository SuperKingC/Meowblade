...
public class UI_dec_01 : GComponent
{
	...
	public const string URL = "ui://hozu168riwm74e";

	public static string Name = "UI_dec_01";

	public static string GetURL()
	{
		return "ui://hozu168riwm74e";
	}

	public static UI_dec_01 CreateInstance()
	{
		return (UI_dec_01)(object)UIPackage.CreateObject("GvGBrawlFight", "dec_01");
	}
	...
	public static UI_dec_01 CreateInstance_ILRuntime()
	{
		...
		UIObjectFactory.SetPackageItemExtension("ui://hozu168riwm74e", (GComponentCreator)(() => HotFixManager.Instance.appdomain.Instantiate<GComponent>(full_name, (object[])null)));
