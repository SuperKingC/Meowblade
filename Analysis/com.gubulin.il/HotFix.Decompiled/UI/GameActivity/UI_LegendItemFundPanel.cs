...
public class UI_LegendItemFundPanel : GComponent
{
	...
	public const string URL = "ui://29q48tv6htyp4c";

	public static string Name = "UI_LegendItemFundPanel";

	public static string GetURL()
	{
		return "ui://29q48tv6htyp4c";
	}

	public static UI_LegendItemFundPanel CreateInstance()
	{
		return (UI_LegendItemFundPanel)(object)UIPackage.CreateObject("GameActivity", "LegendItemFundPanel");
	}

	public static UI_LegendItemFundPanel CreateInstance_ILRuntime()
	{
		//IL_0028: Unknown result type (might be due to invalid IL or missing references)
		//IL_0032: Expected O, but got Unknown
		string full_name = typeof(UI_LegendItemFundPanel).FullName;
		UIObjectFactory.SetPackageItemExtension("ui://29q48tv6htyp4c", (GComponentCreator)(() => HotFixManager.Instance.appdomain.Instantiate<GComponent>(full_name, (object[])null)));
	...
	public override void ConstructFromXML(XML xml)
	{
		...
		string id = "ui://29q48tv6htyp4c".Replace("ui://", "") + "-" + ((GObject)investText).id;
		...
		string id2 = "ui://29q48tv6htyp4c".Replace("ui://", "") + "-" + ((GObject)investTextSea).id;
