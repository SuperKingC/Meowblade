...
public class UI_HelpPanel : GComponent
{
	...
	public const string URL = "ui://29q48tv6h95m2n";

	public static string Name = "UI_HelpPanel";

	public static string GetURL()
	{
		return "ui://29q48tv6h95m2n";
	}

	public static UI_HelpPanel CreateInstance()
	{
		return (UI_HelpPanel)(object)UIPackage.CreateObject("GameActivity", "HelpPanel");
	}
	...
	public static UI_HelpPanel CreateInstance_ILRuntime()
	{
		...
		UIObjectFactory.SetPackageItemExtension("ui://29q48tv6h95m2n", (GComponentCreator)(() => HotFixManager.Instance.appdomain.Instantiate<GComponent>(full_name, (object[])null)));
