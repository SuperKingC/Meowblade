...
public class UI_rewardBtn155 : GButton
{
	...
	public const string URL = "ui://29q48tv6oa38s";

	public static string Name = "UI_rewardBtn155";

	public static string GetURL()
	{
		return "ui://29q48tv6oa38s";
	}

	public static UI_rewardBtn155 CreateInstance()
	{
		return (UI_rewardBtn155)(object)UIPackage.CreateObject("GameActivity", "rewardBtn155");
	}
	...
	public static UI_rewardBtn155 CreateInstance_ILRuntime()
	{
		...
		UIObjectFactory.SetPackageItemExtension("ui://29q48tv6oa38s", (GComponentCreator)(() => HotFixManager.Instance.appdomain.Instantiate<GComponent>(full_name, (object[])null)));
	...
	public override void ConstructFromXML(XML xml)
	{
		...
		string id = "ui://29q48tv6oa38s".Replace("ui://", "") + "-" + ((GObject)num).id;
