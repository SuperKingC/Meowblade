...
public class UI_GemFundPanel : GComponent
{
	...
	public const string URL = "ui://29q48tv6n4413w";

	public static string Name = "UI_GemFundPanel";

	public static string GetURL()
	{
		return "ui://29q48tv6n4413w";
	}

	public static UI_GemFundPanel CreateInstance()
	{
		return (UI_GemFundPanel)(object)UIPackage.CreateObject("GameActivity", "GemFundPanel");
	}

	public static UI_GemFundPanel CreateInstance_ILRuntime()
	{
		//IL_0028: Unknown result type (might be due to invalid IL or missing references)
		//IL_0032: Expected O, but got Unknown
		string full_name = typeof(UI_GemFundPanel).FullName;
		UIObjectFactory.SetPackageItemExtension("ui://29q48tv6n4413w", (GComponentCreator)(() => HotFixManager.Instance.appdomain.Instantiate<GComponent>(full_name, (object[])null)));
	...
	public override void ConstructFromXML(XML xml)
	{
		...
		string id = "ui://29q48tv6n4413w".Replace("ui://", "") + "-" + ((GObject)investText).id;
		...
		string id2 = "ui://29q48tv6n4413w".Replace("ui://", "") + "-" + ((GObject)investTextSea).id;
