...
public class UI_com_effCoinFlash : GComponent
{
	...
	public const string URL = "ui://29q48tv6fjnn3f";

	public static string Name = "UI_com_effCoinFlash";

	public static string GetURL()
	{
		return "ui://29q48tv6fjnn3f";
	}

	public static UI_com_effCoinFlash CreateInstance()
	{
		return (UI_com_effCoinFlash)(object)UIPackage.CreateObject("GameActivity", "com_effCoinFlash");
	}
	...
	public static UI_com_effCoinFlash CreateInstance_ILRuntime()
	{
		...
		UIObjectFactory.SetPackageItemExtension("ui://29q48tv6fjnn3f", (GComponentCreator)(() => HotFixManager.Instance.appdomain.Instantiate<GComponent>(full_name, (object[])null)));
