...
public class UI_dec_02 : GComponent
{
	...
	public const string URL = "ui://pwrbvhpvkh5k7a";

	public static string Name = "UI_dec_02";

	public static string GetURL()
	{
		return "ui://pwrbvhpvkh5k7a";
	}

	public static UI_dec_02 CreateInstance()
	{
		return (UI_dec_02)(object)UIPackage.CreateObject("GvGShipPopup", "dec_02");
	}
	...
	public static UI_dec_02 CreateInstance_ILRuntime()
	{
		...
		UIObjectFactory.SetPackageItemExtension("ui://pwrbvhpvkh5k7a", (GComponentCreator)(() => HotFixManager.Instance.appdomain.Instantiate<GComponent>(full_name, (object[])null)));
