...
public class UI_WorkerItem : GButton
{
	...
	public const string URL = "ui://pwrbvhpvlb9h3l";

	public static string Name = "UI_WorkerItem";

	public static string GetURL()
	{
		return "ui://pwrbvhpvlb9h3l";
	}

	public static UI_WorkerItem CreateInstance()
	{
		return (UI_WorkerItem)(object)UIPackage.CreateObject("GvGShipPopup", "WorkerItem");
	}
	...
	public static UI_WorkerItem CreateInstance_ILRuntime()
	{
		...
		UIObjectFactory.SetPackageItemExtension("ui://pwrbvhpvlb9h3l", (GComponentCreator)(() => HotFixManager.Instance.appdomain.Instantiate<GComponent>(full_name, (object[])null)));
