...
public class UI_com_Amplifier : GComponent
{
	...
	public const string URL = "ui://5k1s1pjxpzxd3";

	public static string Name = "UI_com_Amplifier";

	public static string GetURL()
	{
		return "ui://5k1s1pjxpzxd3";
	}

	public static UI_com_Amplifier CreateInstance()
	{
		return (UI_com_Amplifier)(object)UIPackage.CreateObject("GvGOEMResult3", "com_Amplifier");
	}
	...
	public static UI_com_Amplifier CreateInstance_ILRuntime()
	{
		...
		UIObjectFactory.SetPackageItemExtension("ui://5k1s1pjxpzxd3", (GComponentCreator)(() => HotFixManager.Instance.appdomain.Instantiate<GComponent>(full_name, (object[])null)));
