...
public class UI_com_PreviewContent : GComponent
{
	...
	public const string URL = "ui://7uylntmmkq2dy";

	public static string Name = "UI_com_PreviewContent";

	public static string GetURL()
	{
		return "ui://7uylntmmkq2dy";
	}

	public static UI_com_PreviewContent CreateInstance()
	{
		return (UI_com_PreviewContent)(object)UIPackage.CreateObject("GvG3SplitBluePrint", "com_PreviewContent");
	}
	...
	public static UI_com_PreviewContent CreateInstance_ILRuntime()
	{
		...
		UIObjectFactory.SetPackageItemExtension("ui://7uylntmmkq2dy", (GComponentCreator)(() => HotFixManager.Instance.appdomain.Instantiate<GComponent>(full_name, (object[])null)));
	...
	public override void ConstructFromXML(XML xml)
	{
		...
		string id = "ui://7uylntmmkq2dy".Replace("ui://", "") + "-" + ((GObject)n5).id;
