...
public class UI_btn_Lock : GButton
{
	...
	public const string URL = "ui://7uylntmmfevs22";

	public static string Name = "UI_btn_Lock";

	public static string GetURL()
	{
		return "ui://7uylntmmfevs22";
	}

	public static UI_btn_Lock CreateInstance()
	{
		return (UI_btn_Lock)(object)UIPackage.CreateObject("GvG3SplitBluePrint", "btn_Lock");
	}
	...
	public static UI_btn_Lock CreateInstance_ILRuntime()
	{
		...
		UIObjectFactory.SetPackageItemExtension("ui://7uylntmmfevs22", (GComponentCreator)(() => HotFixManager.Instance.appdomain.Instantiate<GComponent>(full_name, (object[])null)));
