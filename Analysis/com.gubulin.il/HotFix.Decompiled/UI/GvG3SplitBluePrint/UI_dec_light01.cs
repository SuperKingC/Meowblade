...
public class UI_dec_light01 : GComponent
{
	...
	public const string URL = "ui://7uylntmmhzei1w";

	public static string Name = "UI_dec_light01";

	public static string GetURL()
	{
		return "ui://7uylntmmhzei1w";
	}

	public static UI_dec_light01 CreateInstance()
	{
		return (UI_dec_light01)(object)UIPackage.CreateObject("GvG3SplitBluePrint", "dec_light01");
	}
	...
	public static UI_dec_light01 CreateInstance_ILRuntime()
	{
		...
		UIObjectFactory.SetPackageItemExtension("ui://7uylntmmhzei1w", (GComponentCreator)(() => HotFixManager.Instance.appdomain.Instantiate<GComponent>(full_name, (object[])null)));
