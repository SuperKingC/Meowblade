...
public class UI_RaceSelectionBtn : GButton
{
	...
	public const string URL = "ui://pwlamcyxgp16n";

	public static string Name = "UI_RaceSelectionBtn";

	public static string GetURL()
	{
		return "ui://pwlamcyxgp16n";
	}

	public static UI_RaceSelectionBtn CreateInstance()
	{
		return (UI_RaceSelectionBtn)(object)UIPackage.CreateObject("GvGAmplifierOnShip", "RaceSelectionBtn");
	}
	...
	public static UI_RaceSelectionBtn CreateInstance_ILRuntime()
	{
		...
		UIObjectFactory.SetPackageItemExtension("ui://pwlamcyxgp16n", (GComponentCreator)(() => HotFixManager.Instance.appdomain.Instantiate<GComponent>(full_name, (object[])null)));
