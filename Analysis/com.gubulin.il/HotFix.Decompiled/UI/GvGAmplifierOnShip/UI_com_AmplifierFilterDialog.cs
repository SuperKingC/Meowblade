...
public class UI_com_AmplifierFilterDialog : GComponent
{
	...
	public const string URL = "ui://pwlamcyxgp16h";
	...
	{
		return "ui://pwlamcyxgp16h";
	}

	public static UI_com_AmplifierFilterDialog CreateInstance()
	{
		return (UI_com_AmplifierFilterDialog)(object)UIPackage.CreateObject("GvGAmplifierOnShip", "com_AmplifierFilterDialog");
	}
	...
	public static UI_com_AmplifierFilterDialog CreateInstance_ILRuntime()
	{
		...
		UIObjectFactory.SetPackageItemExtension("ui://pwlamcyxgp16h", (GComponentCreator)(() => HotFixManager.Instance.appdomain.Instantiate<GComponent>(full_name, (object[])null)));
