...
public class UI_soliderItem : GButton
{
	...
	public const string URL = "ui://9u6qpm6phqom17";

	public static string Name = "UI_soliderItem";

	public static string GetURL()
	{
		return "ui://9u6qpm6phqom17";
	}

	public static UI_soliderItem CreateInstance()
	{
		return (UI_soliderItem)(object)UIPackage.CreateObject("Playback", "soliderItem");
	}
	...
	public static UI_soliderItem CreateInstance_ILRuntime()
	{
		...
		UIObjectFactory.SetPackageItemExtension("ui://9u6qpm6phqom17", (GComponentCreator)(() => HotFixManager.Instance.appdomain.Instantiate<GComponent>(full_name, (object[])null)));
	...
	public override void ConstructFromXML(XML xml)
	{
		...
		string id = "ui://9u6qpm6phqom17".Replace("ui://", "") + "-" + ((GObject)lv).id;
