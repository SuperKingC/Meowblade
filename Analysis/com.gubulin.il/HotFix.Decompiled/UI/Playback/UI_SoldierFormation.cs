...
public class UI_SoldierFormation : GButton
{
	...
	public const string URL = "ui://9u6qpm6phqom16";

	public static string Name = "UI_SoldierFormation";

	public static string GetURL()
	{
		return "ui://9u6qpm6phqom16";
	}

	public static UI_SoldierFormation CreateInstance()
	{
		return (UI_SoldierFormation)(object)UIPackage.CreateObject("Playback", "SoldierFormation");
	}
	...
	public static UI_SoldierFormation CreateInstance_ILRuntime()
	{
		...
		UIObjectFactory.SetPackageItemExtension("ui://9u6qpm6phqom16", (GComponentCreator)(() => HotFixManager.Instance.appdomain.Instantiate<GComponent>(full_name, (object[])null)));
	...
	public override void ConstructFromXML(XML xml)
	{
		...
		string id = "ui://9u6qpm6phqom16".Replace("ui://", "") + "-" + ((GObject)num).id;
