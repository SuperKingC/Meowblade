...
public class UI_InvitationIcon : GButton
{
	...
	public const string URL = "ui://9u6qpm6pt6gcb";

	public static string Name = "UI_InvitationIcon";

	public static string GetURL()
	{
		return "ui://9u6qpm6pt6gcb";
	}

	public static UI_InvitationIcon CreateInstance()
	{
		return (UI_InvitationIcon)(object)UIPackage.CreateObject("Playback", "InvitationIcon");
	}
	...
	public static UI_InvitationIcon CreateInstance_ILRuntime()
	{
		...
		UIObjectFactory.SetPackageItemExtension("ui://9u6qpm6pt6gcb", (GComponentCreator)(() => HotFixManager.Instance.appdomain.Instantiate<GComponent>(full_name, (object[])null)));
