...
public class UI_ComboBox2 : GComponent
{
	...
	public const string URL = "ui://b9yxt7u0qhyr72";

	public static string Name = "UI_ComboBox2";

	public static string GetURL()
	{
		return "ui://b9yxt7u0qhyr72";
	}

	public static UI_ComboBox2 CreateInstance()
	{
		return (UI_ComboBox2)(object)UIPackage.CreateObject("AccountInfo", "ComboBox2");
	}
	...
	public static UI_ComboBox2 CreateInstance_ILRuntime()
	{
		...
		UIObjectFactory.SetPackageItemExtension("ui://b9yxt7u0qhyr72", (GComponentCreator)(() => HotFixManager.Instance.appdomain.Instantiate<GComponent>(full_name, (object[])null)));
	...
	public override void ConstructFromXML(XML xml)
	{
		...
		string id = "ui://b9yxt7u0qhyr72".Replace("ui://", "") + "-" + ((GObject)title).id;
