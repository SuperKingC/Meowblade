...
public class UI_btn_AllSelect : GButton
{
	...
	public const string URL = "ui://4eq8fgd2o8el30";

	public static string Name = "UI_btn_AllSelect";

	public static string GetURL()
	{
		return "ui://4eq8fgd2o8el30";
	}

	public static UI_btn_AllSelect CreateInstance()
	{
		return (UI_btn_AllSelect)(object)UIPackage.CreateObject("GvGWorldMap3", "btn_AllSelect");
	}
	...
	public static UI_btn_AllSelect CreateInstance_ILRuntime()
	{
		...
		UIObjectFactory.SetPackageItemExtension("ui://4eq8fgd2o8el30", (GComponentCreator)(() => HotFixManager.Instance.appdomain.Instantiate<GComponent>(full_name, (object[])null)));
	...
	public override void ConstructFromXML(XML xml)
	{
		...
		string id = "ui://4eq8fgd2o8el30".Replace("ui://", "") + "-" + ((GObject)n6).id;
		((GObject)n6).text = LanguagesManager.GetDesc(id);
		n8 = (GTextField)((GComponent)this).GetChild("n8");
		string id2 = "ui://4eq8fgd2o8el30".Replace("ui://", "") + "-" + ((GObject)n8).id;
