...
public class UI_com_Ability : GComponent
{
	...
	public const string URL = "ui://4eq8fgd2zit4ac";

	public static string Name = "UI_com_Ability";

	public static string GetURL()
	{
		return "ui://4eq8fgd2zit4ac";
	}

	public static UI_com_Ability CreateInstance()
	{
		return (UI_com_Ability)(object)UIPackage.CreateObject("GvGWorldMap3", "com_Ability");
	}
	...
	public static UI_com_Ability CreateInstance_ILRuntime()
	{
		...
		UIObjectFactory.SetPackageItemExtension("ui://4eq8fgd2zit4ac", (GComponentCreator)(() => HotFixManager.Instance.appdomain.Instantiate<GComponent>(full_name, (object[])null)));
