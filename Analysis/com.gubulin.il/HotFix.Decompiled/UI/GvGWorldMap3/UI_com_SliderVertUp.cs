...
public class UI_com_SliderVertUp : GComponent
{
	...
	public const string URL = "ui://4eq8fgd2bqhp9";
	...
	{
		return "ui://4eq8fgd2bqhp9";
	}

	public static UI_com_SliderVertUp CreateInstance()
	{
		return (UI_com_SliderVertUp)(object)UIPackage.CreateObject("GvGWorldMap3", "com_SliderVertUp");
	}
	...
	public static UI_com_SliderVertUp CreateInstance_ILRuntime()
	{
		...
		UIObjectFactory.SetPackageItemExtension("ui://4eq8fgd2bqhp9", (GComponentCreator)(() => HotFixManager.Instance.appdomain.Instantiate<GComponent>(full_name, (object[])null)));
