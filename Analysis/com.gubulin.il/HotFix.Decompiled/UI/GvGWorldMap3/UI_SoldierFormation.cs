...
public class UI_SoldierFormation : GButton
{
	...
	public const string URL = "ui://4eq8fgd2aibkb6sdu";

	public static string Name = "UI_SoldierFormation";

	public static string GetURL()
	{
		return "ui://4eq8fgd2aibkb6sdu";
	}

	public static UI_SoldierFormation CreateInstance()
	{
		return (UI_SoldierFormation)(object)UIPackage.CreateObject("GvGWorldMap3", "SoldierFormation");
	}
	...
	public static UI_SoldierFormation CreateInstance_ILRuntime()
	{
		...
		UIObjectFactory.SetPackageItemExtension("ui://4eq8fgd2aibkb6sdu", (GComponentCreator)(() => HotFixManager.Instance.appdomain.Instantiate<GComponent>(full_name, (object[])null)));
	...
	public override void ConstructFromXML(XML xml)
	{
		...
		string id = "ui://4eq8fgd2aibkb6sdu".Replace("ui://", "") + "-" + ((GObject)num).id;
