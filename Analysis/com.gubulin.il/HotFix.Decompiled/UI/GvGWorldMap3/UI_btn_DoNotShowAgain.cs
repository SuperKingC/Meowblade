...
public class UI_btn_DoNotShowAgain : GButton
{
	...
	public const string URL = "ui://4eq8fgd2iwfbqb6sf1";

	public static string Name = "UI_btn_DoNotShowAgain";

	public static string GetURL()
	{
		return "ui://4eq8fgd2iwfbqb6sf1";
	}

	public static UI_btn_DoNotShowAgain CreateInstance()
	{
		return (UI_btn_DoNotShowAgain)(object)UIPackage.CreateObject("GvGWorldMap3", "btn_DoNotShowAgain");
	}
	...
	public static UI_btn_DoNotShowAgain CreateInstance_ILRuntime()
	{
		...
		UIObjectFactory.SetPackageItemExtension("ui://4eq8fgd2iwfbqb6sf1", (GComponentCreator)(() => HotFixManager.Instance.appdomain.Instantiate<GComponent>(full_name, (object[])null)));
	...
	public override void ConstructFromXML(XML xml)
	{
		...
		string id = "ui://4eq8fgd2iwfbqb6sf1".Replace("ui://", "") + "-" + ((GObject)n8).id;
