...
public class UI_soliderItem : GButton
{
	...
	public const string URL = "ui://4eq8fgd2aibkb6sdv";

	public static string Name = "UI_soliderItem";

	public static string GetURL()
	{
		return "ui://4eq8fgd2aibkb6sdv";
	}

	public static UI_soliderItem CreateInstance()
	{
		return (UI_soliderItem)(object)UIPackage.CreateObject("GvGWorldMap3", "soliderItem");
	}
	...
	public static UI_soliderItem CreateInstance_ILRuntime()
	{
		...
		UIObjectFactory.SetPackageItemExtension("ui://4eq8fgd2aibkb6sdv", (GComponentCreator)(() => HotFixManager.Instance.appdomain.Instantiate<GComponent>(full_name, (object[])null)));
	...
	public override void ConstructFromXML(XML xml)
	{
		...
		string id = "ui://4eq8fgd2aibkb6sdv".Replace("ui://", "") + "-" + ((GObject)lv).id;
