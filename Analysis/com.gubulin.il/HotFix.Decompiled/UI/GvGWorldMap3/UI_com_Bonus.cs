...
public class UI_com_Bonus : GComponent
{
	...
	public const string URL = "ui://4eq8fgd2dc6m8a";

	public static string Name = "UI_com_Bonus";

	public static string GetURL()
	{
		return "ui://4eq8fgd2dc6m8a";
	}

	public static UI_com_Bonus CreateInstance()
	{
		return (UI_com_Bonus)(object)UIPackage.CreateObject("GvGWorldMap3", "com_Bonus");
	}
	...
	public static UI_com_Bonus CreateInstance_ILRuntime()
	{
		...
		UIObjectFactory.SetPackageItemExtension("ui://4eq8fgd2dc6m8a", (GComponentCreator)(() => HotFixManager.Instance.appdomain.Instantiate<GComponent>(full_name, (object[])null)));
