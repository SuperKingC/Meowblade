...
public class UI_com_AmplifierModel : GComponent
{
	...
	public const string URL = "ui://hotvoz3ppg604k";

	public static string Name = "UI_com_AmplifierModel";

	public static string GetURL()
	{
		return "ui://hotvoz3ppg604k";
	}

	public static UI_com_AmplifierModel CreateInstance()
	{
		return (UI_com_AmplifierModel)(object)UIPackage.CreateObject("GvGOEMForge3", "com_AmplifierModel");
	}
	...
	public static UI_com_AmplifierModel CreateInstance_ILRuntime()
	{
		...
		UIObjectFactory.SetPackageItemExtension("ui://hotvoz3ppg604k", (GComponentCreator)(() => HotFixManager.Instance.appdomain.Instantiate<GComponent>(full_name, (object[])null)));
