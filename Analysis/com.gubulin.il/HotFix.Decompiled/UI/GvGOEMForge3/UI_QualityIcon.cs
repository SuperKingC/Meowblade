...
public class UI_QualityIcon : GComponent
{
	...
	public const string URL = "ui://hotvoz3ppg603z";

	public static string Name = "UI_QualityIcon";

	public static string GetURL()
	{
		return "ui://hotvoz3ppg603z";
	}

	public static UI_QualityIcon CreateInstance()
	{
		return (UI_QualityIcon)(object)UIPackage.CreateObject("GvGOEMForge3", "QualityIcon");
	}
	...
	public static UI_QualityIcon CreateInstance_ILRuntime()
	{
		...
		UIObjectFactory.SetPackageItemExtension("ui://hotvoz3ppg603z", (GComponentCreator)(() => HotFixManager.Instance.appdomain.Instantiate<GComponent>(full_name, (object[])null)));
