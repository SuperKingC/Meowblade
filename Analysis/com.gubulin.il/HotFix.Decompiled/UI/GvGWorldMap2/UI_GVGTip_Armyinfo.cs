...
public class UI_GVGTip_Armyinfo : GComponent
{
	...
	public const string URL = "ui://hd2s9kukzebn4v";

	public static string Name = "UI_GVGTip_Armyinfo";

	public static string GetURL()
	{
		return "ui://hd2s9kukzebn4v";
	}

	public static UI_GVGTip_Armyinfo CreateInstance()
	{
		return (UI_GVGTip_Armyinfo)(object)UIPackage.CreateObject("GvGWorldMap2", "GVGTip_Armyinfo");
	}
	...
	public static UI_GVGTip_Armyinfo CreateInstance_ILRuntime()
	{
		...
		UIObjectFactory.SetPackageItemExtension("ui://hd2s9kukzebn4v", (GComponentCreator)(() => HotFixManager.Instance.appdomain.Instantiate<GComponent>(full_name, (object[])null)));
	...
	public override void ConstructFromXML(XML xml)
	{
		...
		string id = "ui://hd2s9kukzebn4v".Replace("ui://", "") + "-" + ((GObject)Content).id;
