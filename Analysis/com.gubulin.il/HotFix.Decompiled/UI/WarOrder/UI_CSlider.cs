...
public class UI_CSlider : GComponent
{
	public GImage Back;
	...
	public const string URL = "ui://ax280w58okbc1n";

	public static string Name = "UI_CSlider";
	...
	{
		return "ui://ax280w58okbc1n";
	}

	public static UI_CSlider CreateInstance()
	{
		return (UI_CSlider)(object)UIPackage.CreateObject("WarOrder", "CSlider");
	}

	public static UI_CSlider CreateInstance_ILRuntime()
	{
		//IL_0028: Unknown result type (might be due to invalid IL or missing references)
		//IL_0032: Expected O, but got Unknown
		string full_name = typeof(UI_CSlider).FullName;
		UIObjectFactory.SetPackageItemExtension("ui://ax280w58okbc1n", (GComponentCreator)(() => HotFixManager.Instance.appdomain.Instantiate<GComponent>(full_name, (object[])null)));
