...
public class UI_btn_DoNotShowAgain : GButton
{
	...
	public const string URL = "ui://u6x0b1gnoip464";

	public static string Name = "UI_btn_DoNotShowAgain";

	public static string GetURL()
	{
		return "ui://u6x0b1gnoip464";
	}

	public static UI_btn_DoNotShowAgain CreateInstance()
	{
		return (UI_btn_DoNotShowAgain)(object)UIPackage.CreateObject("GvGShipDetail", "btn_DoNotShowAgain");
	}
	...
	public static UI_btn_DoNotShowAgain CreateInstance_ILRuntime()
	{
		...
		UIObjectFactory.SetPackageItemExtension("ui://u6x0b1gnoip464", (GComponentCreator)(() => HotFixManager.Instance.appdomain.Instantiate<GComponent>(full_name, (object[])null)));
	...
	public override void ConstructFromXML(XML xml)
	{
		...
		string id = "ui://u6x0b1gnoip464".Replace("ui://", "") + "-" + ((GObject)n8).id;
