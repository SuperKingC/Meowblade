...
public class UI_workerBackItem : GButton
{
	...
	public const string URL = "ui://u6x0b1gnw9n030";

	public static string Name = "UI_workerBackItem";

	public static string GetURL()
	{
		return "ui://u6x0b1gnw9n030";
	}

	public static UI_workerBackItem CreateInstance()
	{
		return (UI_workerBackItem)(object)UIPackage.CreateObject("GvGShipDetail", "workerBackItem");
	}
	...
	public static UI_workerBackItem CreateInstance_ILRuntime()
	{
		...
		UIObjectFactory.SetPackageItemExtension("ui://u6x0b1gnw9n030", (GComponentCreator)(() => HotFixManager.Instance.appdomain.Instantiate<GComponent>(full_name, (object[])null)));
