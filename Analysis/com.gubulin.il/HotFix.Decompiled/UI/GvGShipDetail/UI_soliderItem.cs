...
public class UI_soliderItem : GButton
{
	...
	public const string URL = "ui://u6x0b1gnfdar6";

	public static string Name = "UI_soliderItem";

	public static string GetURL()
	{
		return "ui://u6x0b1gnfdar6";
	}

	public static UI_soliderItem CreateInstance()
	{
		return (UI_soliderItem)(object)UIPackage.CreateObject("GvGShipDetail", "soliderItem");
	}
	...
	public static UI_soliderItem CreateInstance_ILRuntime()
	{
		...
		UIObjectFactory.SetPackageItemExtension("ui://u6x0b1gnfdar6", (GComponentCreator)(() => HotFixManager.Instance.appdomain.Instantiate<GComponent>(full_name, (object[])null)));
	...
	public override void ConstructFromXML(XML xml)
	{
		...
		string id = "ui://u6x0b1gnfdar6".Replace("ui://", "") + "-" + ((GObject)lv).id;
