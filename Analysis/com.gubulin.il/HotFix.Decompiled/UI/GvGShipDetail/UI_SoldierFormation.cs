...
public class UI_SoldierFormation : GButton
{
	...
	public const string URL = "ui://u6x0b1gnfdar5";

	public static string Name = "UI_SoldierFormation";

	public static string GetURL()
	{
		return "ui://u6x0b1gnfdar5";
	}

	public static UI_SoldierFormation CreateInstance()
	{
		return (UI_SoldierFormation)(object)UIPackage.CreateObject("GvGShipDetail", "SoldierFormation");
	}
	...
	public static UI_SoldierFormation CreateInstance_ILRuntime()
	{
		...
		UIObjectFactory.SetPackageItemExtension("ui://u6x0b1gnfdar5", (GComponentCreator)(() => HotFixManager.Instance.appdomain.Instantiate<GComponent>(full_name, (object[])null)));
	...
	public override void ConstructFromXML(XML xml)
	{
		...
		string id = "ui://u6x0b1gnfdar5".Replace("ui://", "") + "-" + ((GObject)num).id;
