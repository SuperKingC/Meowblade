...
public class UI_SoldierIconOnTouch : GComponent
{
	...
	public const string URL = "ui://u6x0b1gnghds39";

	public static string Name = "UI_SoldierIconOnTouch";

	public static string GetURL()
	{
		return "ui://u6x0b1gnghds39";
	}

	public static UI_SoldierIconOnTouch CreateInstance()
	{
		return (UI_SoldierIconOnTouch)(object)UIPackage.CreateObject("GvGShipDetail", "SoldierIconOnTouch");
	}
	...
	public static UI_SoldierIconOnTouch CreateInstance_ILRuntime()
	{
		...
		UIObjectFactory.SetPackageItemExtension("ui://u6x0b1gnghds39", (GComponentCreator)(() => HotFixManager.Instance.appdomain.Instantiate<GComponent>(full_name, (object[])null)));
