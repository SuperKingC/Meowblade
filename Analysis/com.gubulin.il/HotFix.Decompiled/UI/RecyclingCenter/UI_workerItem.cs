...
public class UI_workerItem : GButton
{
	...
	public const string URL = "ui://72poq8plkxixq";

	public static string Name = "UI_workerItem";

	public static string GetURL()
	{
		return "ui://72poq8plkxixq";
	}

	public static UI_workerItem CreateInstance()
	{
		return (UI_workerItem)(object)UIPackage.CreateObject("RecyclingCenter", "workerItem");
	}
	...
	public static UI_workerItem CreateInstance_ILRuntime()
	{
		...
		UIObjectFactory.SetPackageItemExtension("ui://72poq8plkxixq", (GComponentCreator)(() => HotFixManager.Instance.appdomain.Instantiate<GComponent>(full_name, (object[])null)));
