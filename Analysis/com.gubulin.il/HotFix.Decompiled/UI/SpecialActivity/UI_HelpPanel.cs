...
public class UI_HelpPanel : GComponent, IUiController
{
	[Serializable]
	[CompilerGenerated]
	...
	public const string URL = "ui://kozswd8hbwf1f40";

	public static string Name = "UI_HelpPanel";

	public static string GetURL()
	{
		return "ui://kozswd8hbwf1f40";
	}

	public static UI_HelpPanel CreateInstance()
	{
		return (UI_HelpPanel)(object)UIPackage.CreateObject("SpecialActivity", "HelpPanel");
	}
	...
	public static UI_HelpPanel CreateInstance_ILRuntime()
	{
		...
		UIObjectFactory.SetPackageItemExtension("ui://kozswd8hbwf1f40", (GComponentCreator)(() => HotFixManager.Instance.appdomain.Instantiate<GComponent>(full_name, (object[])null)));
