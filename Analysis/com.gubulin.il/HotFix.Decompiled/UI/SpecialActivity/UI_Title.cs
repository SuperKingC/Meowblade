...
public class UI_Title : GComponent
{
	...
	public const string URL = "ui://kozswd8hndja1";

	public static string Name = "UI_Title";

	public static string GetURL()
	{
		return "ui://kozswd8hndja1";
	}

	public static UI_Title CreateInstance()
	{
		return (UI_Title)(object)UIPackage.CreateObject("SpecialActivity", "Title");
	}
	...
	public static UI_Title CreateInstance_ILRuntime()
	{
		...
		UIObjectFactory.SetPackageItemExtension("ui://kozswd8hndja1", (GComponentCreator)(() => HotFixManager.Instance.appdomain.Instantiate<GComponent>(full_name, (object[])null)));
