...
public class UI_SignInDayLoader : GButton
{
	...
	public const string URL = "ui://kozswd8hndjag";

	public static string Name = "UI_SignInDayLoader";

	public static string GetURL()
	{
		return "ui://kozswd8hndjag";
	}

	public static UI_SignInDayLoader CreateInstance()
	{
		return (UI_SignInDayLoader)(object)UIPackage.CreateObject("SpecialActivity", "SignInDayLoader");
	}
	...
	public static UI_SignInDayLoader CreateInstance_ILRuntime()
	{
		...
		UIObjectFactory.SetPackageItemExtension("ui://kozswd8hndjag", (GComponentCreator)(() => HotFixManager.Instance.appdomain.Instantiate<GComponent>(full_name, (object[])null)));
