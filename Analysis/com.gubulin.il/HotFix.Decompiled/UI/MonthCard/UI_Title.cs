...
public class UI_Title : GComponent
{
	...
	public const string URL = "ui://4ctl553savmf8";

	public static string Name = "UI_Title";

	public static string GetURL()
	{
		return "ui://4ctl553savmf8";
	}

	public static UI_Title CreateInstance()
	{
		return (UI_Title)(object)UIPackage.CreateObject("MonthCard", "Title");
	}
	...
	public static UI_Title CreateInstance_ILRuntime()
	{
		...
		UIObjectFactory.SetPackageItemExtension("ui://4ctl553savmf8", (GComponentCreator)(() => HotFixManager.Instance.appdomain.Instantiate<GComponent>(full_name, (object[])null)));
