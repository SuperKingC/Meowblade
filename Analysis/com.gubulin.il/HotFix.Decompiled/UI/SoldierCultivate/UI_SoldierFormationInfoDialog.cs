...
public class UI_SoldierFormationInfoDialog : GComponent
{
	...
	public const string URL = "ui://7dantnbimol06x";

	public static string Name = "UI_SoldierFormationInfoDialog";

	public static string GetURL()
	{
		return "ui://7dantnbimol06x";
	}

	public static UI_SoldierFormationInfoDialog CreateInstance()
	{
		return (UI_SoldierFormationInfoDialog)(object)UIPackage.CreateObject("SoldierCultivate", "SoldierFormationInfoDialog");
	}
	...
	public static UI_SoldierFormationInfoDialog CreateInstance_ILRuntime()
	{
		...
		UIObjectFactory.SetPackageItemExtension("ui://7dantnbimol06x", (GComponentCreator)(() => HotFixManager.Instance.appdomain.Instantiate<GComponent>(full_name, (object[])null)));
