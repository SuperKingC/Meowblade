...
public class UI_SoldierPromotionPanel : GComponent
{
	...
	public const string URL = "ui://7dantnbih7os75";

	public static string Name = "UI_SoldierPromotionPanel";

	public static string GetURL()
	{
		return "ui://7dantnbih7os75";
	}

	public static UI_SoldierPromotionPanel CreateInstance()
	{
		return (UI_SoldierPromotionPanel)(object)UIPackage.CreateObject("SoldierCultivate", "SoldierPromotionPanel");
	}
	...
	public static UI_SoldierPromotionPanel CreateInstance_ILRuntime()
	{
		...
		UIObjectFactory.SetPackageItemExtension("ui://7dantnbih7os75", (GComponentCreator)(() => HotFixManager.Instance.appdomain.Instantiate<GComponent>(full_name, (object[])null)));
