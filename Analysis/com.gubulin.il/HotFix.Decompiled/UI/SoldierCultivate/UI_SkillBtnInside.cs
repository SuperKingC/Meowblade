...
public class UI_SkillBtnInside : GButton
{
	...
	public const string URL = "ui://7dantnbiv93kt7l";

	public static string Name = "UI_SkillBtnInside";

	public static string GetURL()
	{
		return "ui://7dantnbiv93kt7l";
	}

	public static UI_SkillBtnInside CreateInstance()
	{
		return (UI_SkillBtnInside)(object)UIPackage.CreateObject("SoldierCultivate", "SkillBtnInside");
	}
	...
	public static UI_SkillBtnInside CreateInstance_ILRuntime()
	{
		...
		UIObjectFactory.SetPackageItemExtension("ui://7dantnbiv93kt7l", (GComponentCreator)(() => HotFixManager.Instance.appdomain.Instantiate<GComponent>(full_name, (object[])null)));
