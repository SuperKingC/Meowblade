...
public class UI_ExperienceProcessBar : GProgressBar
{
	...
	public const string URL = "ui://7dantnbionm22";

	public static string Name = "UI_ExperienceProcessBar";

	public static string GetURL()
	{
		return "ui://7dantnbionm22";
	}

	public static UI_ExperienceProcessBar CreateInstance()
	{
		return (UI_ExperienceProcessBar)(object)UIPackage.CreateObject("SoldierCultivate", "ExperienceProcessBar");
	}
	...
	public static UI_ExperienceProcessBar CreateInstance_ILRuntime()
	{
		...
		UIObjectFactory.SetPackageItemExtension("ui://7dantnbionm22", (GComponentCreator)(() => HotFixManager.Instance.appdomain.Instantiate<GComponent>(full_name, (object[])null)));
