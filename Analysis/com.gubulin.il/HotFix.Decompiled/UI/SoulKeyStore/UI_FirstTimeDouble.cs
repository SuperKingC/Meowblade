...
public class UI_FirstTimeDouble : GButton
{
	...
	public const string URL = "ui://3nd2hqkivzbke";

	public static string Name = "UI_FirstTimeDouble";

	public static string GetURL()
	{
		return "ui://3nd2hqkivzbke";
	}

	public static UI_FirstTimeDouble CreateInstance()
	{
		return (UI_FirstTimeDouble)(object)UIPackage.CreateObject("SoulKeyStore", "FirstTimeDouble");
	}
	...
	public static UI_FirstTimeDouble CreateInstance_ILRuntime()
	{
		...
		UIObjectFactory.SetPackageItemExtension("ui://3nd2hqkivzbke", (GComponentCreator)(() => HotFixManager.Instance.appdomain.Instantiate<GComponent>(full_name, (object[])null)));
	...
	public override void ConstructFromXML(XML xml)
	{
		...
		string id = "ui://3nd2hqkivzbke".Replace("ui://", "") + "-" + ((GObject)title).id;
		((GObject)title).text = LanguagesManager.GetDesc(id);
		time = (GTextField)((GComponent)this).GetChild("time");
		string id2 = "ui://3nd2hqkivzbke".Replace("ui://", "") + "-" + ((GObject)time).id;
