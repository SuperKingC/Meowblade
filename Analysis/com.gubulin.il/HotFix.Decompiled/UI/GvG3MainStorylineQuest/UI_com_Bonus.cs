...
public class UI_com_Bonus : GComponent
{
	...
	public const string URL = "ui://249h3k3dqf7c1l";

	public static string Name = "UI_com_Bonus";

	public static string GetURL()
	{
		return "ui://249h3k3dqf7c1l";
	}

	public static UI_com_Bonus CreateInstance()
	{
		return (UI_com_Bonus)(object)UIPackage.CreateObject("GvG3MainStorylineQuest", "com_Bonus");
	}
	...
	public static UI_com_Bonus CreateInstance_ILRuntime()
	{
		...
		UIObjectFactory.SetPackageItemExtension("ui://249h3k3dqf7c1l", (GComponentCreator)(() => HotFixManager.Instance.appdomain.Instantiate<GComponent>(full_name, (object[])null)));
