...
public class UI_com_BrawlWaitNight : GComponent, IFairyComponent
{
	...
	public const string URL = "ui://249h3k3d9bk2s5o";

	public static string Name = "UI_com_BrawlWaitNight";
	...
	{
		return "ui://249h3k3d9bk2s5o";
	}

	public static UI_com_BrawlWaitNight CreateInstance()
	{
		return (UI_com_BrawlWaitNight)(object)UIPackage.CreateObject("GvG3MainStorylineQuest", "com_BrawlWaitNight");
	}

	public static UI_com_BrawlWaitNight CreateInstance_ILRuntime()
	{
		//IL_0028: Unknown result type (might be due to invalid IL or missing references)
		//IL_0032: Expected O, but got Unknown
		string full_name = typeof(UI_com_BrawlWaitNight).FullName;
		UIObjectFactory.SetPackageItemExtension("ui://249h3k3d9bk2s5o", (GComponentCreator)(() => HotFixManager.Instance.appdomain.Instantiate<GComponent>(full_name, (object[])null)));
	...
	public override void ConstructFromXML(XML xml)
	{
		...
		string id = "ui://249h3k3d9bk2s5o".Replace("ui://", "") + "-" + ((GObject)n1).id;
		((GObject)n1).text = LanguagesManager.GetDesc(id);
		n2 = (GTextField)((GComponent)this).GetChild("n2");
		string id2 = "ui://249h3k3d9bk2s5o".Replace("ui://", "") + "-" + ((GObject)n2).id;
		...
		string id3 = "ui://249h3k3d9bk2s5o".Replace("ui://", "") + "-" + ((GObject)n8).id;
