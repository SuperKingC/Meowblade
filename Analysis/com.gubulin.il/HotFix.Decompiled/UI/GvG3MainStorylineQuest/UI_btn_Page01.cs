...
public class UI_btn_Page01 : GButton
{
	...
	public const string URL = "ui://249h3k3dqf7c1b";

	public static string Name = "UI_btn_Page01";

	public static string GetURL()
	{
		return "ui://249h3k3dqf7c1b";
	}

	public static UI_btn_Page01 CreateInstance()
	{
		return (UI_btn_Page01)(object)UIPackage.CreateObject("GvG3MainStorylineQuest", "btn_Page01");
	}
	...
	public static UI_btn_Page01 CreateInstance_ILRuntime()
	{
		...
		UIObjectFactory.SetPackageItemExtension("ui://249h3k3dqf7c1b", (GComponentCreator)(() => HotFixManager.Instance.appdomain.Instantiate<GComponent>(full_name, (object[])null)));
