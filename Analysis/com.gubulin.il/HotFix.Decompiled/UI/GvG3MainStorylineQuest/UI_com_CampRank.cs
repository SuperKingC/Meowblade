...
public class UI_com_CampRank : GComponent
{
	...
	public const string URL = "ui://249h3k3dqf7c1k";

	public static string Name = "UI_com_CampRank";

	public static string GetURL()
	{
		return "ui://249h3k3dqf7c1k";
	}

	public static UI_com_CampRank CreateInstance()
	{
		return (UI_com_CampRank)(object)UIPackage.CreateObject("GvG3MainStorylineQuest", "com_CampRank");
	}
	...
	public static UI_com_CampRank CreateInstance_ILRuntime()
	{
		...
		UIObjectFactory.SetPackageItemExtension("ui://249h3k3dqf7c1k", (GComponentCreator)(() => HotFixManager.Instance.appdomain.Instantiate<GComponent>(full_name, (object[])null)));
