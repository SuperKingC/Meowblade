...
public class UI_HelpDialog : GComponent
{
	...
	public const string URL = "ui://avplaivdxooot5r";

	public static string Name = "UI_HelpDialog";

	public static string GetURL()
	{
		return "ui://avplaivdxooot5r";
	}

	public static UI_HelpDialog CreateInstance()
	{
		return (UI_HelpDialog)(object)UIPackage.CreateObject("Contract", "HelpDialog");
	}
	...
	public static UI_HelpDialog CreateInstance_ILRuntime()
	{
		...
		UIObjectFactory.SetPackageItemExtension("ui://avplaivdxooot5r", (GComponentCreator)(() => HotFixManager.Instance.appdomain.Instantiate<GComponent>(full_name, (object[])null)));
