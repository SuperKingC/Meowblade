...
public class UI_SliverCardFront : GComponent
{
	...
	public const string URL = "ui://avplaivdvecsc";

	public static string Name = "UI_SliverCardFront";

	public static string GetURL()
	{
		return "ui://avplaivdvecsc";
	}

	public static UI_SliverCardFront CreateInstance()
	{
		return (UI_SliverCardFront)(object)UIPackage.CreateObject("Contract", "SliverCardFront");
	}

	public static UI_SliverCardFront CreateInstance_ILRuntime()
	{
		//IL_0028: Unknown result type (might be due to invalid IL or missing references)
		//IL_0032: Expected O, but got Unknown
		string full_name = typeof(UI_SliverCardFront).FullName;
		UIObjectFactory.SetPackageItemExtension("ui://avplaivdvecsc", (GComponentCreator)(() => HotFixManager.Instance.appdomain.Instantiate<GComponent>(full_name, (object[])null)));
	...
	public override void ConstructFromXML(XML xml)
	{
		...
		string id = "ui://avplaivdvecsc".Replace("ui://", "") + "-" + ((GObject)title).id;
		((GObject)title).text = LanguagesManager.GetDesc(id);
		introduction = (GRichTextField)((GComponent)this).GetChild("introduction");
		string id2 = "ui://avplaivdvecsc".Replace("ui://", "") + "-" + ((GObject)introduction).id;
		...
		string id3 = "ui://avplaivdvecsc".Replace("ui://", "") + "-" + ((GObject)soldierName).id;
