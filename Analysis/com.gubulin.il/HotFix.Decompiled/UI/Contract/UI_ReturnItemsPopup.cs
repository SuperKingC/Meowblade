...
public class UI_ReturnItemsPopup : GComponent
{
	...
	public const string URL = "ui://avplaivdxbr9t5g";

	public static string Name = "UI_ReturnItemsPopup";

	public static string GetURL()
	{
		return "ui://avplaivdxbr9t5g";
	}

	public static UI_ReturnItemsPopup CreateInstance()
	{
		return (UI_ReturnItemsPopup)(object)UIPackage.CreateObject("Contract", "ReturnItemsPopup");
	}
	...
	public static UI_ReturnItemsPopup CreateInstance_ILRuntime()
	{
		...
		UIObjectFactory.SetPackageItemExtension("ui://avplaivdxbr9t5g", (GComponentCreator)(() => HotFixManager.Instance.appdomain.Instantiate<GComponent>(full_name, (object[])null)));
