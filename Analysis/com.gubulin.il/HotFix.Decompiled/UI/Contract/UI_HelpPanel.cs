...
public class UI_HelpPanel : GComponent
{
	...
	public const string URL = "ui://avplaivdxooot5q";

	public static string Name = "UI_HelpPanel";

	public static string GetURL()
	{
		return "ui://avplaivdxooot5q";
	}

	public static UI_HelpPanel CreateInstance()
	{
		return (UI_HelpPanel)(object)UIPackage.CreateObject("Contract", "HelpPanel");
	}
	...
	public static UI_HelpPanel CreateInstance_ILRuntime()
	{
		...
		UIObjectFactory.SetPackageItemExtension("ui://avplaivdxooot5q", (GComponentCreator)(() => HotFixManager.Instance.appdomain.Instantiate<GComponent>(full_name, (object[])null)));
