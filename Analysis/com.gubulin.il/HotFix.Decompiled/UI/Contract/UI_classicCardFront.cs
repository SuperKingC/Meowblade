...
public class UI_classicCardFront : GComponent
{
	public GButton generalCard;
	...
	public const string URL = "ui://avplaivdoppx1k";

	public static string Name = "UI_classicCardFront";

	public static string GetURL()
	{
		return "ui://avplaivdoppx1k";
	}

	public static UI_classicCardFront CreateInstance()
	{
		return (UI_classicCardFront)(object)UIPackage.CreateObject("Contract", "classicCardFront");
	}

	public static UI_classicCardFront CreateInstance_ILRuntime()
	{
		//IL_0028: Unknown result type (might be due to invalid IL or missing references)
		//IL_0032: Expected O, but got Unknown
		string full_name = typeof(UI_classicCardFront).FullName;
		UIObjectFactory.SetPackageItemExtension("ui://avplaivdoppx1k", (GComponentCreator)(() => HotFixManager.Instance.appdomain.Instantiate<GComponent>(full_name, (object[])null)));
	...
	public override void ConstructFromXML(XML xml)
	{
		...
		generalCard = (GButton)((GComponent)this).GetChild("generalCard");
		icon = (GLoader)((GComponent)this).GetChild("icon");
		title = (GRichTextField)((GComponent)this).GetChild("title");
		string id = "ui://avplaivdoppx1k".Replace("ui://", "") + "-" + ((GObject)title).id;
		((GObject)title).text = LanguagesManager.GetDesc(id);
		introduction = (GRichTextField)((GComponent)this).GetChild("introduction");
		string id2 = "ui://avplaivdoppx1k".Replace("ui://", "") + "-" + ((GObject)introduction).id;
		...
		string id3 = "ui://avplaivdoppx1k".Replace("ui://", "") + "-" + ((GObject)soldierName).id;
