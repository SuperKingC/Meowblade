...
public class UI_AdvancedCardFront : GComponent
{
	...
	public const string URL = "ui://6n2woz97o4kt3";

	public static string Name = "UI_AdvancedCardFront";

	public static string GetURL()
	{
		return "ui://6n2woz97o4kt3";
	}

	public static UI_AdvancedCardFront CreateInstance()
	{
		return (UI_AdvancedCardFront)(object)UIPackage.CreateObject("DebrisCompound", "AdvancedCardFront");
	}
