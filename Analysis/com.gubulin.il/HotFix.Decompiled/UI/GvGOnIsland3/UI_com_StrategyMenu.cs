...
public class UI_com_StrategyMenu : GComponent
{
	...
	public const string URL = "ui://ebc4ciwrx1i01y";

	public static string Name = "UI_com_StrategyMenu";

	public static string GetURL()
	{
		return "ui://ebc4ciwrx1i01y";
	}

	public static UI_com_StrategyMenu CreateInstance()
	{
		return (UI_com_StrategyMenu)(object)UIPackage.CreateObject("GvGOnIsland3", "com_StrategyMenu");
	}
	...
	public static UI_com_StrategyMenu CreateInstance_ILRuntime()
	{
		...
		UIObjectFactory.SetPackageItemExtension("ui://ebc4ciwrx1i01y", (GComponentCreator)(() => HotFixManager.Instance.appdomain.Instantiate<GComponent>(full_name, (object[])null)));
