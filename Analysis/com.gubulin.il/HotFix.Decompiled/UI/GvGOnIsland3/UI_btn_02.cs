...
public class UI_btn_02 : GButton
{
	...
	public const string URL = "ui://ebc4ciwrndngq6t";

	public static string Name = "UI_btn_02";

	public static string GetURL()
	{
		return "ui://ebc4ciwrndngq6t";
	}

	public static UI_btn_02 CreateInstance()
	{
		return (UI_btn_02)(object)UIPackage.CreateObject("GvGOnIsland3", "btn_02");
	}
	...
	public static UI_btn_02 CreateInstance_ILRuntime()
	{
		...
		UIObjectFactory.SetPackageItemExtension("ui://ebc4ciwrndngq6t", (GComponentCreator)(() => HotFixManager.Instance.appdomain.Instantiate<GComponent>(full_name, (object[])null)));
