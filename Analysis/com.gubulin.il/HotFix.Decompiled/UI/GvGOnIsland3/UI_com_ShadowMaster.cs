...
public class UI_com_ShadowMaster : GComponent
{
	...
	public const string URL = "ui://ebc4ciwris3qq63";

	public static string Name = "UI_com_ShadowMaster";

	public static string GetURL()
	{
		return "ui://ebc4ciwris3qq63";
	}

	public static UI_com_ShadowMaster CreateInstance()
	{
		return (UI_com_ShadowMaster)(object)UIPackage.CreateObject("GvGOnIsland3", "com_ShadowMaster");
	}
	...
	public static UI_com_ShadowMaster CreateInstance_ILRuntime()
	{
		...
		UIObjectFactory.SetPackageItemExtension("ui://ebc4ciwris3qq63", (GComponentCreator)(() => HotFixManager.Instance.appdomain.Instantiate<GComponent>(full_name, (object[])null)));
