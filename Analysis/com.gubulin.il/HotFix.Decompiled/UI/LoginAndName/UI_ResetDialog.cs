...
public class UI_ResetDialog : GComponent
{
	...
	public const string URL = "ui://yb3s7uv7xhx93f";

	public static string Name = "UI_ResetDialog";

	public static string GetURL()
	{
		return "ui://yb3s7uv7xhx93f";
	}

	public static UI_ResetDialog CreateInstance()
	{
		return (UI_ResetDialog)(object)UIPackage.CreateObject("LoginAndName", "ResetDialog");
	}
	...
	public static UI_ResetDialog CreateInstance_ILRuntime()
	{
		...
		UIObjectFactory.SetPackageItemExtension("ui://yb3s7uv7xhx93f", (GComponentCreator)(() => HotFixManager.Instance.appdomain.Instantiate<GComponent>(full_name, (object[])null)));
	...
	public override void ConstructFromXML(XML xml)
	{
		...
		string id = "ui://yb3s7uv7xhx93f".Replace("ui://", "") + "-" + ((GObject)title).id;
