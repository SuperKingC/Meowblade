...
public class UI_com_Title : GComponent
{
	...
	public const string URL = "ui://f1wmtifub4va1";

	public static string Name = "UI_com_Title";

	public static string GetURL()
	{
		return "ui://f1wmtifub4va1";
	}

	public static UI_com_Title CreateInstance()
	{
		return (UI_com_Title)(object)UIPackage.CreateObject("GvGAmplifierEntries", "com_Title");
	}
	...
	public static UI_com_Title CreateInstance_ILRuntime()
	{
		...
		UIObjectFactory.SetPackageItemExtension("ui://f1wmtifub4va1", (GComponentCreator)(() => HotFixManager.Instance.appdomain.Instantiate<GComponent>(full_name, (object[])null)));
	...
	public override void ConstructFromXML(XML xml)
	{
		...
		string id = "ui://f1wmtifub4va1".Replace("ui://", "") + "-" + ((GObject)buildingName).id;
