...
public class UI_FirstTimeDouble : GButton
{
	...
	public const string URL = "ui://4fqsd8h6avmf1";

	public static string Name = "UI_FirstTimeDouble";

	public static string GetURL()
	{
		return "ui://4fqsd8h6avmf1";
	}

	public static UI_FirstTimeDouble CreateInstance()
	{
		return (UI_FirstTimeDouble)(object)UIPackage.CreateObject("GiftBag", "FirstTimeDouble");
	}
	...
	public static UI_FirstTimeDouble CreateInstance_ILRuntime()
	{
		...
		UIObjectFactory.SetPackageItemExtension("ui://4fqsd8h6avmf1", (GComponentCreator)(() => HotFixManager.Instance.appdomain.Instantiate<GComponent>(full_name, (object[])null)));
	...
	public override void ConstructFromXML(XML xml)
	{
		...
		string id = "ui://4fqsd8h6avmf1".Replace("ui://", "") + "-" + ((GObject)title).id;
		((GObject)title).text = LanguagesManager.GetDesc(id);
		time = (GTextField)((GComponent)this).GetChild("time");
		string id2 = "ui://4fqsd8h6avmf1".Replace("ui://", "") + "-" + ((GObject)time).id;
