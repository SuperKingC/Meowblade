...
public class UI_FormationBtn : GButton
{
	...
	public const string URL = "ui://0i520nzmtlapo7m";

	public static string Name = "UI_FormationBtn";

	public static string GetURL()
	{
		return "ui://0i520nzmtlapo7m";
	}

	public static UI_FormationBtn CreateInstance()
	{
		return (UI_FormationBtn)(object)UIPackage.CreateObject("LordOfDreams", "FormationBtn");
	}
	...
	public static UI_FormationBtn CreateInstance_ILRuntime()
	{
		...
		UIObjectFactory.SetPackageItemExtension("ui://0i520nzmtlapo7m", (GComponentCreator)(() => HotFixManager.Instance.appdomain.Instantiate<GComponent>(full_name, (object[])null)));
