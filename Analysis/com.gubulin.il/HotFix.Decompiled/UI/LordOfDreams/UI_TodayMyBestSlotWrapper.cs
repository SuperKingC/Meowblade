...
public class UI_TodayMyBestSlotWrapper : GComponent
{
	...
	public const string URL = "ui://0i520nzmtlapo6w";

	public static string Name = "UI_TodayMyBestSlotWrapper";

	public static string GetURL()
	{
		return "ui://0i520nzmtlapo6w";
	}

	public static UI_TodayMyBestSlotWrapper CreateInstance()
	{
		return (UI_TodayMyBestSlotWrapper)(object)UIPackage.CreateObject("LordOfDreams", "TodayMyBestSlotWrapper");
	}

	public static UI_TodayMyBestSlotWrapper CreateInstance_ILRuntime()
	{
		//IL_0028: Unknown result type (might be due to invalid IL or missing references)
		//IL_0032: Expected O, but got Unknown
		string full_name = typeof(UI_TodayMyBestSlotWrapper).FullName;
		UIObjectFactory.SetPackageItemExtension("ui://0i520nzmtlapo6w", (GComponentCreator)(() => HotFixManager.Instance.appdomain.Instantiate<GComponent>(full_name, (object[])null)));
	...
	public override void ConstructFromXML(XML xml)
	{
		...
		string id = "ui://0i520nzmtlapo6w".Replace("ui://", "") + "-" + ((GObject)n4).id;
		...
		string id2 = "ui://0i520nzmtlapo6w".Replace("ui://", "") + "-" + ((GObject)plus).id;
