...
public class UI_CurFormation : GComponent
{
	...
	public const string URL = "ui://0i520nzmtlapo7l";
	...
	private Action<string> OnFormationChange;

	public static string GetURL()
	{
		return "ui://0i520nzmtlapo7l";
	}

	public static UI_CurFormation CreateInstance()
	{
		return (UI_CurFormation)(object)UIPackage.CreateObject("LordOfDreams", "CurFormation");
	}
	...
	public static UI_CurFormation CreateInstance_ILRuntime()
	{
		...
		UIObjectFactory.SetPackageItemExtension("ui://0i520nzmtlapo7l", (GComponentCreator)(() => HotFixManager.Instance.appdomain.Instantiate<GComponent>(full_name, (object[])null)));
	...
	public void Init(string _fid, Action<string> onFormationChange)
	{
		...
		UpdateFormation(_fid);
		OnFormationChange(_fid);
	}

	public void UpdateFormation(string _fid)
	{
	...
	private void RenderCurFormation(UI_FormationBtn _curFormationBtn, string _formationId)
	{
		...
		_curFormationBtn.formationIcon.url = "ui://LordOfDreams/" + formation.Icon;
