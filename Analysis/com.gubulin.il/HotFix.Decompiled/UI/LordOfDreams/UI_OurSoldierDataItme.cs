...
public class UI_OurSoldierDataItme : GButton
{
	...
	public const string URL = "ui://0i520nzmt300o6c";

	public static string Name = "UI_OurSoldierDataItme";

	public static string GetURL()
	{
		return "ui://0i520nzmt300o6c";
	}

	public static UI_OurSoldierDataItme CreateInstance()
	{
		return (UI_OurSoldierDataItme)(object)UIPackage.CreateObject("LordOfDreams", "OurSoldierDataItme");
	}
	...
	public static UI_OurSoldierDataItme CreateInstance_ILRuntime()
	{
		...
		UIObjectFactory.SetPackageItemExtension("ui://0i520nzmt300o6c", (GComponentCreator)(() => HotFixManager.Instance.appdomain.Instantiate<GComponent>(full_name, (object[])null)));
	...
	public override void ConstructFromXML(XML xml)
	{
		...
		string id = "ui://0i520nzmt300o6c".Replace("ui://", "") + "-" + ((GObject)num).id;
