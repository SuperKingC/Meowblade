...
public class UI_SoldierFormation : GButton
{
	...
	public const string URL = "ui://0i520nzmtlapo7d";

	public static string Name = "UI_SoldierFormation";

	public static string GetURL()
	{
		return "ui://0i520nzmtlapo7d";
	}

	public static UI_SoldierFormation CreateInstance()
	{
		return (UI_SoldierFormation)(object)UIPackage.CreateObject("LordOfDreams", "SoldierFormation");
	}
	...
	public static UI_SoldierFormation CreateInstance_ILRuntime()
	{
		...
		UIObjectFactory.SetPackageItemExtension("ui://0i520nzmtlapo7d", (GComponentCreator)(() => HotFixManager.Instance.appdomain.Instantiate<GComponent>(full_name, (object[])null)));
	...
	public override void ConstructFromXML(XML xml)
	{
		...
		string id = "ui://0i520nzmtlapo7d".Replace("ui://", "") + "-" + ((GObject)num).id;
