...
public class UI_GvGBossAvatar : GComponent
{
	...
	public const string URL = "ui://twlbabiccvfml7";

	public static string Name = "UI_GvGBossAvatar";

	public static string GetURL()
	{
		return "ui://twlbabiccvfml7";
	}

	public static UI_GvGBossAvatar CreateInstance()
	{
		return (UI_GvGBossAvatar)(object)UIPackage.CreateObject("Battle", "GvGBossAvatar");
	}
	...
	public static UI_GvGBossAvatar CreateInstance_ILRuntime()
	{
		...
		UIObjectFactory.SetPackageItemExtension("ui://twlbabiccvfml7", (GComponentCreator)(() => HotFixManager.Instance.appdomain.Instantiate<GComponent>(full_name, (object[])null)));
