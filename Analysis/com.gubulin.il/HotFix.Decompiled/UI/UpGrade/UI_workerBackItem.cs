...
public class UI_workerBackItem : GButton
{
	...
	public const string URL = "ui://lrjfe94hheure";

	public static string Name = "UI_workerBackItem";

	public static string GetURL()
	{
		return "ui://lrjfe94hheure";
	}

	public static UI_workerBackItem CreateInstance()
	{
		return (UI_workerBackItem)(object)UIPackage.CreateObject("UpGrade", "workerBackItem");
	}
	...
	public static UI_workerBackItem CreateInstance_ILRuntime()
	{
		...
		UIObjectFactory.SetPackageItemExtension("ui://lrjfe94hheure", (GComponentCreator)(() => HotFixManager.Instance.appdomain.Instantiate<GComponent>(full_name, (object[])null)));
