...
public class UI_jobSschedule : GProgressBar
{
	...
	public const string URL = "ui://lrjfe94hxfax5q";

	public static string Name = "UI_jobSschedule";

	public static string GetURL()
	{
		return "ui://lrjfe94hxfax5q";
	}

	public static UI_jobSschedule CreateInstance()
	{
		return (UI_jobSschedule)(object)UIPackage.CreateObject("UpGrade", "jobSschedule");
	}
	...
	public static UI_jobSschedule CreateInstance_ILRuntime()
	{
		...
		UIObjectFactory.SetPackageItemExtension("ui://lrjfe94hxfax5q", (GComponentCreator)(() => HotFixManager.Instance.appdomain.Instantiate<GComponent>(full_name, (object[])null)));
	...
	public override void ConstructFromXML(XML xml)
	{
		...
		string id = "ui://lrjfe94hxfax5q".Replace("ui://", "") + "-" + ((GObject)time).id;
