...
public class UI_com_MissionSlot : GComponent
{
	...
	public const string URL = "ui://11dkggb8c2sz30";

	public static string Name = "UI_com_MissionSlot";

	public static string GetURL()
	{
		return "ui://11dkggb8c2sz30";
	}

	public static UI_com_MissionSlot CreateInstance()
	{
		return (UI_com_MissionSlot)(object)UIPackage.CreateObject("WeekActivityPass", "com_MissionSlot");
	}
	...
	public static UI_com_MissionSlot CreateInstance_ILRuntime()
	{
		...
		UIObjectFactory.SetPackageItemExtension("ui://11dkggb8c2sz30", (GComponentCreator)(() => HotFixManager.Instance.appdomain.Instantiate<GComponent>(full_name, (object[])null)));
