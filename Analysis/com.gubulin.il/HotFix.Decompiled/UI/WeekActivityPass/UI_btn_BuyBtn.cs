...
public class UI_btn_BuyBtn : GButton
{
	...
	public const string URL = "ui://11dkggb8nk8fh";

	public static string Name = "UI_btn_BuyBtn";

	public static string GetURL()
	{
		return "ui://11dkggb8nk8fh";
	}

	public static UI_btn_BuyBtn CreateInstance()
	{
		return (UI_btn_BuyBtn)(object)UIPackage.CreateObject("WeekActivityPass", "btn_BuyBtn");
	}
	...
	public static UI_btn_BuyBtn CreateInstance_ILRuntime()
	{
		...
		UIObjectFactory.SetPackageItemExtension("ui://11dkggb8nk8fh", (GComponentCreator)(() => HotFixManager.Instance.appdomain.Instantiate<GComponent>(full_name, (object[])null)));
	...
	public override void ConstructFromXML(XML xml)
	{
		...
		string id = "ui://11dkggb8nk8fh".Replace("ui://", "") + "-" + ((GObject)Price).id;
