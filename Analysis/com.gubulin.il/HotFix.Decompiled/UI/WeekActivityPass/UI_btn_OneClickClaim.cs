...
public class UI_btn_OneClickClaim : GButton
{
	...
	public const string URL = "ui://11dkggb8nk8f2";

	public static string Name = "UI_btn_OneClickClaim";

	public static string GetURL()
	{
		return "ui://11dkggb8nk8f2";
	}

	public static UI_btn_OneClickClaim CreateInstance()
	{
		return (UI_btn_OneClickClaim)(object)UIPackage.CreateObject("WeekActivityPass", "btn_OneClickClaim");
	}
	...
	public static UI_btn_OneClickClaim CreateInstance_ILRuntime()
	{
		...
		UIObjectFactory.SetPackageItemExtension("ui://11dkggb8nk8f2", (GComponentCreator)(() => HotFixManager.Instance.appdomain.Instantiate<GComponent>(full_name, (object[])null)));
