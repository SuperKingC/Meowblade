...
public class UI_dec_light04 : GComponent
{
	...
	public const string URL = "ui://tvr786zlojop3o";

	public static string Name = "UI_dec_light04";

	public static string GetURL()
	{
		return "ui://tvr786zlojop3o";
	}

	public static UI_dec_light04 CreateInstance()
	{
		return (UI_dec_light04)(object)UIPackage.CreateObject("GvGFlagship3", "dec_light04");
	}
	...
	public static UI_dec_light04 CreateInstance_ILRuntime()
	{
		...
		UIObjectFactory.SetPackageItemExtension("ui://tvr786zlojop3o", (GComponentCreator)(() => HotFixManager.Instance.appdomain.Instantiate<GComponent>(full_name, (object[])null)));
