...
public class UI_dec_light03 : GComponent
{
	...
	public const string URL = "ui://tvr786zlojop3n";

	public static string Name = "UI_dec_light03";

	public static string GetURL()
	{
		return "ui://tvr786zlojop3n";
	}

	public static UI_dec_light03 CreateInstance()
	{
		return (UI_dec_light03)(object)UIPackage.CreateObject("GvGFlagship3", "dec_light03");
	}
	...
	public static UI_dec_light03 CreateInstance_ILRuntime()
	{
		...
		UIObjectFactory.SetPackageItemExtension("ui://tvr786zlojop3n", (GComponentCreator)(() => HotFixManager.Instance.appdomain.Instantiate<GComponent>(full_name, (object[])null)));
