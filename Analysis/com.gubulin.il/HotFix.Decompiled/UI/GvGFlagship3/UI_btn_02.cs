...
public class UI_btn_02 : GButton
{
	...
	public const string URL = "ui://tvr786zlt5vl1k";

	public static string Name = "UI_btn_02";

	public static string GetURL()
	{
		return "ui://tvr786zlt5vl1k";
	}

	public static UI_btn_02 CreateInstance()
	{
		return (UI_btn_02)(object)UIPackage.CreateObject("GvGFlagship3", "btn_02");
	}
	...
	public static UI_btn_02 CreateInstance_ILRuntime()
	{
		...
		UIObjectFactory.SetPackageItemExtension("ui://tvr786zlt5vl1k", (GComponentCreator)(() => HotFixManager.Instance.appdomain.Instantiate<GComponent>(full_name, (object[])null)));
