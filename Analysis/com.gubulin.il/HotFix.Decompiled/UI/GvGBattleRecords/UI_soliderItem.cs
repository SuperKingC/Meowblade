...
public class UI_soliderItem : GButton
{
	...
	public const string URL = "ui://dxmilktydzls1c";

	public static string Name = "UI_soliderItem";

	public static string GetURL()
	{
		return "ui://dxmilktydzls1c";
	}

	public static UI_soliderItem CreateInstance()
	{
		return (UI_soliderItem)(object)UIPackage.CreateObject("GvGBattleRecords", "soliderItem");
	}
	...
	public static UI_soliderItem CreateInstance_ILRuntime()
	{
		...
		UIObjectFactory.SetPackageItemExtension("ui://dxmilktydzls1c", (GComponentCreator)(() => HotFixManager.Instance.appdomain.Instantiate<GComponent>(full_name, (object[])null)));
	...
	public override void ConstructFromXML(XML xml)
	{
		...
		string id = "ui://dxmilktydzls1c".Replace("ui://", "") + "-" + ((GObject)lv).id;
