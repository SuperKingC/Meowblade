...
public class UI_EnemyStandardFormationSketchMap : GComponent
{
	...
	public const string URL = "ui://dxmilktydzls1h";

	public static string Name = "UI_EnemyStandardFormationSketchMap";

	public static string GetURL()
	{
		return "ui://dxmilktydzls1h";
	}

	public static UI_EnemyStandardFormationSketchMap CreateInstance()
	{
		return (UI_EnemyStandardFormationSketchMap)(object)UIPackage.CreateObject("GvGBattleRecords", "EnemyStandardFormationSketchMap");
	}
	...
	public static UI_EnemyStandardFormationSketchMap CreateInstance_ILRuntime()
	{
		...
		UIObjectFactory.SetPackageItemExtension("ui://dxmilktydzls1h", (GComponentCreator)(() => HotFixManager.Instance.appdomain.Instantiate<GComponent>(full_name, (object[])null)));
