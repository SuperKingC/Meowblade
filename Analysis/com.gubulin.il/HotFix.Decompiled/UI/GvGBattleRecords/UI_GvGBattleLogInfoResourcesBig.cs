...
public class UI_GvGBattleLogInfoResourcesBig : GComponent
{
	...
	public const string URL = "ui://dxmilktyf8jh22";

	public static string Name = "UI_GvGBattleLogInfoResourcesBig";

	public static string GetURL()
	{
		return "ui://dxmilktyf8jh22";
	}

	public static UI_GvGBattleLogInfoResourcesBig CreateInstance()
	{
		return (UI_GvGBattleLogInfoResourcesBig)(object)UIPackage.CreateObject("GvGBattleRecords", "GvGBattleLogInfoResourcesBig");
	}
	...
	public static UI_GvGBattleLogInfoResourcesBig CreateInstance_ILRuntime()
	{
		...
		UIObjectFactory.SetPackageItemExtension("ui://dxmilktyf8jh22", (GComponentCreator)(() => HotFixManager.Instance.appdomain.Instantiate<GComponent>(full_name, (object[])null)));
	...
	public override void ConstructFromXML(XML xml)
	{
		...
		string id = "ui://dxmilktyf8jh22".Replace("ui://", "") + "-" + ((GObject)Day).id;
		...
		string id2 = "ui://dxmilktyf8jh22".Replace("ui://", "") + "-" + ((GObject)TotalDamageTitle).id;
		...
		string id3 = "ui://dxmilktyf8jh22".Replace("ui://", "") + "-" + ((GObject)n59).id;
