...
public class UI_StandardFormationSketchMap : GComponent
{
	...
	public const string URL = "ui://dxmilktydzls18";

	public static string Name = "UI_StandardFormationSketchMap";

	public static string GetURL()
	{
		return "ui://dxmilktydzls18";
	}

	public static UI_StandardFormationSketchMap CreateInstance()
	{
		return (UI_StandardFormationSketchMap)(object)UIPackage.CreateObject("GvGBattleRecords", "StandardFormationSketchMap");
	}
	...
	public static UI_StandardFormationSketchMap CreateInstance_ILRuntime()
	{
		...
		UIObjectFactory.SetPackageItemExtension("ui://dxmilktydzls18", (GComponentCreator)(() => HotFixManager.Instance.appdomain.Instantiate<GComponent>(full_name, (object[])null)));
