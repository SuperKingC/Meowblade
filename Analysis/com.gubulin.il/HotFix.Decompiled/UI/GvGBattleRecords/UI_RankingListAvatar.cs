...
public class UI_RankingListAvatar : GButton
{
	...
	public const string URL = "ui://dxmilktydzls0";

	public static string Name = "UI_RankingListAvatar";

	public static string GetURL()
	{
		return "ui://dxmilktydzls0";
	}

	public static UI_RankingListAvatar CreateInstance()
	{
		return (UI_RankingListAvatar)(object)UIPackage.CreateObject("GvGBattleRecords", "RankingListAvatar");
	}
	...
	public static UI_RankingListAvatar CreateInstance_ILRuntime()
	{
		...
		UIObjectFactory.SetPackageItemExtension("ui://dxmilktydzls0", (GComponentCreator)(() => HotFixManager.Instance.appdomain.Instantiate<GComponent>(full_name, (object[])null)));
