...
public class UI_OurInfomationBar : GComponent
{
	...
	public const string URL = "ui://dxmilktydzls16";

	public static string Name = "UI_OurInfomationBar";

	public static string GetURL()
	{
		return "ui://dxmilktydzls16";
	}

	public static UI_OurInfomationBar CreateInstance()
	{
		return (UI_OurInfomationBar)(object)UIPackage.CreateObject("GvGBattleRecords", "OurInfomationBar");
	}
	...
	public static UI_OurInfomationBar CreateInstance_ILRuntime()
	{
		...
		UIObjectFactory.SetPackageItemExtension("ui://dxmilktydzls16", (GComponentCreator)(() => HotFixManager.Instance.appdomain.Instantiate<GComponent>(full_name, (object[])null)));
