...
public class UI_SoldierFormation : GButton
{
	...
	public const string URL = "ui://dxmilktydzls1b";

	public static string Name = "UI_SoldierFormation";

	public static string GetURL()
	{
		return "ui://dxmilktydzls1b";
	}

	public static UI_SoldierFormation CreateInstance()
	{
		return (UI_SoldierFormation)(object)UIPackage.CreateObject("GvGBattleRecords", "SoldierFormation");
	}
	...
	public static UI_SoldierFormation CreateInstance_ILRuntime()
	{
		...
		UIObjectFactory.SetPackageItemExtension("ui://dxmilktydzls1b", (GComponentCreator)(() => HotFixManager.Instance.appdomain.Instantiate<GComponent>(full_name, (object[])null)));
	...
	public override void ConstructFromXML(XML xml)
	{
		...
		string id = "ui://dxmilktydzls1b".Replace("ui://", "") + "-" + ((GObject)num).id;
