...
public class UI_workerBackItem : GButton
{
	...
	public const string URL = "ui://k6y9jq3ap75o1f";

	public static string Name = "UI_workerBackItem";

	public static string GetURL()
	{
		return "ui://k6y9jq3ap75o1f";
	}

	public static UI_workerBackItem CreateInstance()
	{
		return (UI_workerBackItem)(object)UIPackage.CreateObject("WorkShop", "workerBackItem");
	}
	...
	public static UI_workerBackItem CreateInstance_ILRuntime()
	{
		...
		UIObjectFactory.SetPackageItemExtension("ui://k6y9jq3ap75o1f", (GComponentCreator)(() => HotFixManager.Instance.appdomain.Instantiate<GComponent>(full_name, (object[])null)));
