...
public class UI_BaseSpine : GComponent
{
	...
	public const string URL = "ui://l5ik1uclpanqtaq";

	public static string Name = "UI_BaseSpine";

	public static string GetURL()
	{
		return "ui://l5ik1uclpanqtaq";
	}

	public static UI_BaseSpine CreateInstance()
	{
		return (UI_BaseSpine)(object)UIPackage.CreateObject("UpgradePotential", "BaseSpine");
	}
	...
	public static UI_BaseSpine CreateInstance_ILRuntime()
	{
		...
		UIObjectFactory.SetPackageItemExtension("ui://l5ik1uclpanqtaq", (GComponentCreator)(() => HotFixManager.Instance.appdomain.Instantiate<GComponent>(full_name, (object[])null)));
