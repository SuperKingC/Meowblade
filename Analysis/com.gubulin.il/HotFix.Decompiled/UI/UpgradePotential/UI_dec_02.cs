...
public class UI_dec_02 : GComponent
{
	...
	public const string URL = "ui://l5ik1uclpanqt9y";

	public static string Name = "UI_dec_02";

	public static string GetURL()
	{
		return "ui://l5ik1uclpanqt9y";
	}

	public static UI_dec_02 CreateInstance()
	{
		return (UI_dec_02)(object)UIPackage.CreateObject("UpgradePotential", "dec_02");
	}
	...
	public static UI_dec_02 CreateInstance_ILRuntime()
	{
		...
		UIObjectFactory.SetPackageItemExtension("ui://l5ik1uclpanqt9y", (GComponentCreator)(() => HotFixManager.Instance.appdomain.Instantiate<GComponent>(full_name, (object[])null)));
