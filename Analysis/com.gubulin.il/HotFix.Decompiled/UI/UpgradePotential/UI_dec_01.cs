...
public class UI_dec_01 : GComponent
{
	...
	public const string URL = "ui://l5ik1uclpanqt9t";

	public static string Name = "UI_dec_01";

	public static string GetURL()
	{
		return "ui://l5ik1uclpanqt9t";
	}

	public static UI_dec_01 CreateInstance()
	{
		return (UI_dec_01)(object)UIPackage.CreateObject("UpgradePotential", "dec_01");
	}
	...
	public static UI_dec_01 CreateInstance_ILRuntime()
	{
		...
		UIObjectFactory.SetPackageItemExtension("ui://l5ik1uclpanqt9t", (GComponentCreator)(() => HotFixManager.Instance.appdomain.Instantiate<GComponent>(full_name, (object[])null)));
