...
public class UI_com_02 : GComponent
{
	...
	public const string URL = "ui://r1j1a2l0iian3c";

	public static string Name = "UI_com_02";

	public static string GetURL()
	{
		return "ui://r1j1a2l0iian3c";
	}

	public static UI_com_02 CreateInstance()
	{
		return (UI_com_02)(object)UIPackage.CreateObject("QQGameActivity", "com_02");
	}
	...
	public static UI_com_02 CreateInstance_ILRuntime()
	{
		...
		UIObjectFactory.SetPackageItemExtension("ui://r1j1a2l0iian3c", (GComponentCreator)(() => HotFixManager.Instance.appdomain.Instantiate<GComponent>(full_name, (object[])null)));
	...
	public override void ConstructFromXML(XML xml)
	{
		...
		ReMainText = (GTextField)((GComponent)this).GetChild("ReMainText");
		ExtraText = (GTextField)((GComponent)this).GetChild("ExtraText");
		string id = "ui://r1j1a2l0iian3c".Replace("ui://", "") + "-" + ((GObject)ExtraText).id;
		((GObject)ExtraText).text = LanguagesManager.GetDesc(id);
		n29 = (GTextField)((GComponent)this).GetChild("n29");
		string id2 = "ui://r1j1a2l0iian3c".Replace("ui://", "") + "-" + ((GObject)n29).id;
