...
public class UI_com_RankBonusSlot : GComponent
{
	...
	public const string URL = "ui://ylvfgf90k1k96c";

	public static string Name = "UI_com_RankBonusSlot";

	public static string GetURL()
	{
		return "ui://ylvfgf90k1k96c";
	}

	public static UI_com_RankBonusSlot CreateInstance()
	{
		return (UI_com_RankBonusSlot)(object)UIPackage.CreateObject("GvG3Leaderboard", "com_RankBonusSlot");
	}
	...
	public static UI_com_RankBonusSlot CreateInstance_ILRuntime()
	{
		...
		UIObjectFactory.SetPackageItemExtension("ui://ylvfgf90k1k96c", (GComponentCreator)(() => HotFixManager.Instance.appdomain.Instantiate<GComponent>(full_name, (object[])null)));
