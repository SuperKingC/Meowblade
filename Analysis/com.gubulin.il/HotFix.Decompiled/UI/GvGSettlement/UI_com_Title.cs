...
public class UI_com_Title : GComponent
{
	...
	public const string URL = "ui://91jxdrkadxm02j";

	public static string Name = "UI_com_Title";

	public static string GetURL()
	{
		return "ui://91jxdrkadxm02j";
	}

	public static UI_com_Title CreateInstance()
	{
		return (UI_com_Title)(object)UIPackage.CreateObject("GvGSettlement", "com_Title");
	}
	...
	public static UI_com_Title CreateInstance_ILRuntime()
	{
		...
		UIObjectFactory.SetPackageItemExtension("ui://91jxdrkadxm02j", (GComponentCreator)(() => HotFixManager.Instance.appdomain.Instantiate<GComponent>(full_name, (object[])null)));
	...
	public override void ConstructFromXML(XML xml)
	{
		...
		string id = "ui://91jxdrkadxm02j".Replace("ui://", "") + "-" + ((GObject)buildingName).id;
