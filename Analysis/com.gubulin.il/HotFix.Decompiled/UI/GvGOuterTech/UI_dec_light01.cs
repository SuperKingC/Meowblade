...
public class UI_dec_light01 : GComponent
{
	...
	public const string URL = "ui://th385mtt7ztlo60";

	public static string Name = "UI_dec_light01";

	public static string GetURL()
	{
		return "ui://th385mtt7ztlo60";
	}

	public static UI_dec_light01 CreateInstance()
	{
		return (UI_dec_light01)(object)UIPackage.CreateObject("GvGOuterTech", "dec_light01");
	}
	...
	public static UI_dec_light01 CreateInstance_ILRuntime()
	{
		...
		UIObjectFactory.SetPackageItemExtension("ui://th385mtt7ztlo60", (GComponentCreator)(() => HotFixManager.Instance.appdomain.Instantiate<GComponent>(full_name, (object[])null)));
