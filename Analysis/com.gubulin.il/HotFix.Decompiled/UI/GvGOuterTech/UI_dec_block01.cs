...
public class UI_dec_block01 : GComponent
{
	...
	public const string URL = "ui://th385mtt7ztlo5r";

	public static string Name = "UI_dec_block01";

	public static string GetURL()
	{
		return "ui://th385mtt7ztlo5r";
	}

	public static UI_dec_block01 CreateInstance()
	{
		return (UI_dec_block01)(object)UIPackage.CreateObject("GvGOuterTech", "dec_block01");
	}
	...
	public static UI_dec_block01 CreateInstance_ILRuntime()
	{
		...
		UIObjectFactory.SetPackageItemExtension("ui://th385mtt7ztlo5r", (GComponentCreator)(() => HotFixManager.Instance.appdomain.Instantiate<GComponent>(full_name, (object[])null)));
