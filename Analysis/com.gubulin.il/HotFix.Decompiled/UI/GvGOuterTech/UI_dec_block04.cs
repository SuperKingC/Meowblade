...
public class UI_dec_block04 : GComponent
{
	...
	public const string URL = "ui://th385mtt7ztlo5v";

	public static string Name = "UI_dec_block04";

	public static string GetURL()
	{
		return "ui://th385mtt7ztlo5v";
	}

	public static UI_dec_block04 CreateInstance()
	{
		return (UI_dec_block04)(object)UIPackage.CreateObject("GvGOuterTech", "dec_block04");
	}
	...
	public static UI_dec_block04 CreateInstance_ILRuntime()
	{
		...
		UIObjectFactory.SetPackageItemExtension("ui://th385mtt7ztlo5v", (GComponentCreator)(() => HotFixManager.Instance.appdomain.Instantiate<GComponent>(full_name, (object[])null)));
