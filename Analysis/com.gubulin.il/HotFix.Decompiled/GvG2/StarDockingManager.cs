...
public class StarDockingManager : DockingManagerBase
{
	public class Slot
	{
		public Vector3 Pos;
	...
	public StarDockingManager(Island parentIsland)
	{
		...
		if (!IsStaticInit)
		{
			...
			float num4 = 1.156f - num;
			float num5 = -0.936f + num;
			...
			((Vector3)(ref v))._002Ector(-0.88f, 0f, 0.746f);
			Vector3 v2 = default(Vector3);
			((Vector3)(ref v2))._002Ector(0.88f, 0f, 0.746f);
			Vector3 v3 = default(Vector3);
			((Vector3)(ref v3))._002Ector(-0.88f, 0f, -0.526f);
			Vector3 v4 = default(Vector3);
			((Vector3)(ref v4))._002Ector(0.88f, 0f, -0.526f);
