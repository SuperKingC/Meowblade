...
public class GDESoldierExperienceData
{
	...
	public int Experience => DC.IntArray[_intOffset];

	public GDESoldierExperienceData(int stringOffset, int intOffset, int floatOffset, int boolOffset, int vector2Offset, int listStringOffset, int listIntOffset)
	{
