...
public class GDESoldierEvoData
{
	...
	public string EvoAttributes => DC.StringArray[_stringOffset + 3];

	public GDESoldierEvoData(int stringOffset, int intOffset, int floatOffset, int boolOffset, int vector2Offset, int listStringOffset, int listIntOffset)
	{
