...
public class GDEStorehouseData
{
	...
	public int Stock => DC.IntArray[_intOffset + 1];

	public int StockSpace => DC.IntArray[_intOffset + 2];

	public string JumpContext => DC.StringArray[_stringOffset + 2];

	public GDEStorehouseData(int stringOffset, int intOffset, int floatOffset, int boolOffset, int vector2Offset, int listStringOffset, int listIntOffset)
	{
