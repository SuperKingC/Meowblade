...
public class GDEMissionSerialData
{
	...
	public List<string> Missions => DC.GetListStringArray(_listStringOffset);

	public string ProgressBonus => DC.StringArray[_stringOffset + 1];

	public string DisplayBonus => DC.StringArray[_stringOffset + 2];

	public GDEMissionSerialData(int stringOffset, int intOffset, int floatOffset, int boolOffset, int vector2Offset, int listStringOffset, int listIntOffset)
	{
