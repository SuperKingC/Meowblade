...
public class GDELanguagesData
{
	...
	public string Template => DC.StringArray[_stringOffset + 1];

	public GDELanguagesData(int stringOffset, int intOffset, int floatOffset, int boolOffset, int vector2Offset, int listStringOffset, int listIntOffset)
	{
