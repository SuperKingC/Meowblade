...
public class GDEDecorativeObjectsData
{
	...
	public GDEDecorativeObjectsData(int stringOffset, int intOffset, int floatOffset, int boolOffset, int vector2Offset, int listStringOffset, int listIntOffset)
	{
