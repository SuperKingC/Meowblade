...
public class GDELegendItemChangePropsCostData
{
	...
	public GDELegendItemChangePropsCostData(int stringOffset, int intOffset, int floatOffset, int boolOffset, int vector2Offset, int listStringOffset, int listIntOffset)
	{
