...
public class GDESoldierFormationData
{
	...
	public GDESoldierFormationData(int stringOffset, int intOffset, int floatOffset, int boolOffset, int vector2Offset, int listStringOffset, int listIntOffset)
	{
