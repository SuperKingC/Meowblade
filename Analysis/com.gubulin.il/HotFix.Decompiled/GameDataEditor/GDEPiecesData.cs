...
public class GDEPiecesData
{
	...
	public int CompositeRequirements => DC.IntArray[_intOffset + 1];

	public string RelativeContext => DC.StringArray[_stringOffset + 2];

	public string Result => DC.StringArray[_stringOffset + 3];

	public GDEPiecesData(int stringOffset, int intOffset, int floatOffset, int boolOffset, int vector2Offset, int listStringOffset, int listIntOffset)
	{
