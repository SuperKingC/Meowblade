...
public class GDERegionData
{
	...
	public string Prefab => DC.StringArray[_stringOffset + 1];

	public string PrefabConfig => DC.StringArray[_stringOffset + 2];

	public string Name => DC.StringArray[_stringOffset + 3];

	public string Desc => DC.StringArray[_stringOffset + 4];

	public string UnlockBonuses => DC.StringArray[_stringOffset + 5];

	public GDERegionData(int stringOffset, int intOffset, int floatOffset, int boolOffset, int vector2Offset, int listStringOffset, int listIntOffset)
	{
