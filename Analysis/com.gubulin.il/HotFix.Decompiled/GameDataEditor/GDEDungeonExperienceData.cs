...
public class GDEDungeonExperienceData
{
	...
	public string BuildingMaxLevel => DC.StringArray[_stringOffset + 3];

	public string ItemMaxLevel => DC.StringArray[_stringOffset + 4];
	...
	public GDEDungeonExperienceData(int stringOffset, int intOffset, int floatOffset, int boolOffset, int vector2Offset, int listStringOffset, int listIntOffset)
	{
