...
public class GDESoldierItemSlotConfigData
{
	...
	public int SlotId => DC.IntArray[_intOffset];

	public string SoldierId => DC.StringArray[_stringOffset + 1];

	public string UnlockConditions => DC.StringArray[_stringOffset + 2];

	public string UnlockRequirements => DC.StringArray[_stringOffset + 3];

	public GDESoldierItemSlotConfigData(int stringOffset, int intOffset, int floatOffset, int boolOffset, int vector2Offset, int listStringOffset, int listIntOffset)
	{
