...
public class GDEProjectileData
{
	...
	public GDEProjectileData(int stringOffset, int intOffset, int floatOffset, int boolOffset, int vector2Offset, int listStringOffset, int listIntOffset)
	{
