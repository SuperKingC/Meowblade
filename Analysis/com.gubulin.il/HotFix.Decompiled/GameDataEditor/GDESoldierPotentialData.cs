...
public class GDESoldierPotentialData
{
	...
	public string Attributes => DC.StringArray[_stringOffset + 2];

	public string Requirement => DC.StringArray[_stringOffset + 3];

	public GDESoldierPotentialData(int stringOffset, int intOffset, int floatOffset, int boolOffset, int vector2Offset, int listStringOffset, int listIntOffset)
	{
