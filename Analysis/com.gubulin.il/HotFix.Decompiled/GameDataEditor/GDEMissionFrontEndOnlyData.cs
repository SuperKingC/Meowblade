...
public class GDEMissionFrontEndOnlyData
{
	...
	public string OnUndergoing => DC.StringArray[_stringOffset + 1];

	public string OnCompleted => DC.StringArray[_stringOffset + 2];

	public string OnClaimed => DC.StringArray[_stringOffset + 3];

	public string OnGoTo => DC.StringArray[_stringOffset + 4];

	public GDEMissionFrontEndOnlyData(int stringOffset, int intOffset, int floatOffset, int boolOffset, int vector2Offset, int listStringOffset, int listIntOffset)
	{
