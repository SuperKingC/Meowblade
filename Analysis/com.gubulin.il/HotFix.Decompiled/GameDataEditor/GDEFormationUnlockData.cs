...
public class GDEFormationUnlockData
{
	...
	public string Cost => DC.StringArray[_stringOffset + 1];

	public GDEFormationUnlockData(int stringOffset, int intOffset, int floatOffset, int boolOffset, int vector2Offset, int listStringOffset, int listIntOffset)
	{
