...
public class GDEAnimationData
{
	...
	public string ModelName => DC.StringArray[_stringOffset + 1];

	public int Animation => DC.IntArray[_intOffset];

	public bool Loop => DC.BoolArray[_boolOffset];

	public GDEAnimationData(int stringOffset, int intOffset, int floatOffset, int boolOffset, int vector2Offset, int listStringOffset, int listIntOffset)
	{
