...
public class GDEPrizePoolComboData
{
	...
	public string ComboConfig => DC.StringArray[_stringOffset + 1];

	public GDEPrizePoolComboData(int stringOffset, int intOffset, int floatOffset, int boolOffset, int vector2Offset, int listStringOffset, int listIntOffset)
	{
