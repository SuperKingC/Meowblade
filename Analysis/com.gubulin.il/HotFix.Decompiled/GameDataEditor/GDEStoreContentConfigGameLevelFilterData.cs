...
public class GDEStoreContentConfigGameLevelFilterData
{
	...
	public string GameLevelFilter => DC.StringArray[_stringOffset + 1];

	public GDEStoreContentConfigGameLevelFilterData(int stringOffset, int intOffset, int floatOffset, int boolOffset, int vector2Offset, int listStringOffset, int listIntOffset)
	{
