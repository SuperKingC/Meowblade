...
public class GDEConfigurationData
{
	...
	public string Type => DC.StringArray[_stringOffset + 1];

	public string Config => DC.StringArray[_stringOffset + 2];

	public GDEConfigurationData(int stringOffset, int intOffset, int floatOffset, int boolOffset, int vector2Offset, int listStringOffset, int listIntOffset)
	{
