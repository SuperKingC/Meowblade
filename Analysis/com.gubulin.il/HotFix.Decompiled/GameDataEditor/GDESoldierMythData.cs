...
public class GDESoldierMythData
{
	...
	public int SStoneCost => DC.IntArray[_intOffset + 1];

	public string OtherCost => DC.StringArray[_stringOffset + 1];

	public string Attr => DC.StringArray[_stringOffset + 2];

	public GDESoldierMythData(int stringOffset, int intOffset, int floatOffset, int boolOffset, int vector2Offset, int listStringOffset, int listIntOffset)
	{
