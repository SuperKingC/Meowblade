...
public class GvG3Unit
{
	public GameObject GO;

	public static int AttackSfxCount;

	private GvG3Group ParentGroup;
	...
	public GvG3Unit(GameObject go, int index, GvG3Group parentGroup)
	{
		...
		MeshRendererList = GO.GetComponentsInChildren<MeshRenderer>(false);
	...
	public void SetFightingTargetGroup(GvG3Group targetGroup)
	{
		...
		if (!HasFightingTarget)
		{
			...
			GvG3Unit gvG3Unit = ListExtensions.Random<GvG3Unit>(targetGroup.MatrixUnits);
			MovingStart = GO.transform.position;
			MovingDelta = gvG3Unit.GO.transform.position - MovingStart;
	...
	public void CheckSoldierCount()
	{
		...
		int num = 0;
		MeshRenderer[] meshRendererList = MeshRendererList;
		foreach (MeshRenderer val in meshRendererList)
		{
