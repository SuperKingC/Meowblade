...
[ProtoContract]
public class S2C_ChangeHoldingCamp : SocketManager.BaseSocketPackageBodyContext
{
	[ProtoContract]
	...
	public S2C_ChangeHoldingCamp()
	{
		base.PackageId = SocketManager.ePackageId.S2C_ChangeHoldingCamp;
