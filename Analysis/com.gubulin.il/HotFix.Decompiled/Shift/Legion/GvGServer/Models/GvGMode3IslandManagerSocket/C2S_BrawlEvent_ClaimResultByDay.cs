...
[ProtoContract]
public class C2S_BrawlEvent_ClaimResultByDay : SocketManager.BaseSocketPackageBodyContext
{
	[ProtoContract]
	...
	public C2S_BrawlEvent_ClaimResultByDay()
	{
		base.PackageId = SocketManager.ePackageId.C2S_BrawlEvent_ClaimResultByDay;
