...
[ProtoContract]
public class S2C_FinishNPCDialogMission : SocketManager.BaseSocketPackageBodyContext
{
	[ProtoContract]
	...
	public S2C_FinishNPCDialogMission()
	{
		base.PackageId = SocketManager.ePackageId.S2C_FinishNPCDialogMission;
