...
[ProtoContract]
public class S2C_CreatePlayerCommand : SocketManager.BaseSocketPackageBodyContext
{
	[ProtoContract]
	public class Request : SocketManager.BaseSocketPackageBody
	{
		...
		public List<RItem> ChangedStorehouse;
	}
	...
	public S2C_CreatePlayerCommand()
	{
		base.PackageId = SocketManager.ePackageId.S2C_CreatePlayerCommand;
