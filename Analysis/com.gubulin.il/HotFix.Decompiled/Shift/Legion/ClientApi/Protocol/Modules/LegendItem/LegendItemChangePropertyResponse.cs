...
[ProtoContract]
public class LegendItemChangePropertyResponse : IPacketBody
{
	[ProtoMember(1)]
	...
	public ItemEntry ItemEntryNeedConfirm { get; set; }
	...
	public int PacketId => PacketIds.MODULES_LEGEND_ITEM_CHANGE_PROPERTY;
}
