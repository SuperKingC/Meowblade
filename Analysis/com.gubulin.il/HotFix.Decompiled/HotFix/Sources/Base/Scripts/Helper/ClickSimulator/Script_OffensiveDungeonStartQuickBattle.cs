...
public class Script_OffensiveDungeonStartQuickBattle : OffensiveDungeonClickSimulatorStep
{
	public Script_OffensiveDungeonStartQuickBattle(OffensiveDungeonLevelLocator levelLocator)
	{
		LevelLocator = levelLocator;
		NextStep = new Script_OffensiveDungeonEndQuickBattle(levelLocator);
	}
	...
	public override IEnumerator Execute()
	{
		...
		if (ClickSimulatorHelper.TryGetUiInstOnTop(UI_UniversalConfirmPopup.Name, out var confirmDialogObj))
		{
			...
			UI_MaskCover.OnTouchBegin(confirmDialog.ConfirmDialog.yesBtn);
