...
public class Script_DefenseDungeonStartQuickBattle : DefenseDungeonClickSimulatorStep
{
	public Script_DefenseDungeonStartQuickBattle(DefenseDungeonLevelLocator levelLocator)
	{
