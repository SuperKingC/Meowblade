...
public class Script_NeutralDungeonRestartQuickBattle : NeutralDungeonClickSimulatorStep
{
	public Script_NeutralDungeonRestartQuickBattle(NeutralDungeonLevelLocator levelLocator)
	{
	...
	public override IEnumerator Execute()
	{
		if (ClickSimulatorHelper.TryGetUiInstOnTop(UI_GameEndPanelVictory.Name, out var uiInst))
		{
			...
			while (!((GObject)victoryPanel.againBtn).visible)
			{
