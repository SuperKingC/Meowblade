...
public class Script_NeutralDungeonEndQuickBattle : NeutralDungeonClickSimulatorStep
{
	public Script_NeutralDungeonEndQuickBattle(NeutralDungeonLevelLocator levelLocator)
	{
