...
public class Script_ThemeDungeonBackToMilitary : ThemeDungeonClickSimulatorStep
{
	public Script_ThemeDungeonBackToMilitary(ThemeDungeonLevelLocator levelLocator)
	{
