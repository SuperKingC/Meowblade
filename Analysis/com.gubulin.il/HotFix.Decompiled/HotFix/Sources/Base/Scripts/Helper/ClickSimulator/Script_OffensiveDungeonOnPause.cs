...
public class Script_OffensiveDungeonOnPause : OffensiveDungeonClickSimulatorStep
{
	public Script_OffensiveDungeonOnPause(OffensiveDungeonLevelLocator levelLocator)
	{
