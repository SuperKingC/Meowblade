...
public class Script_OffensiveDungeonStartBattle : OffensiveDungeonClickSimulatorStep
{
	public Script_OffensiveDungeonStartBattle(OffensiveDungeonLevelLocator levelLocator)
	{
	...
	public override IEnumerator Execute()
	{
		...
		NextStep = new Script_OffensiveDungeonEndBattle(LevelLocator);
		yield return null;
	}
}
