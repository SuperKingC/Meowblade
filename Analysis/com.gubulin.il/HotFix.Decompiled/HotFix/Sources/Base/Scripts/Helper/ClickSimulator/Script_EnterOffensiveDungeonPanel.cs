...
public class Script_EnterOffensiveDungeonPanel : OffensiveDungeonClickSimulatorStep
{
	public Script_EnterOffensiveDungeonPanel(OffensiveDungeonLevelLocator levelLocator)
	{
	...
	public override IEnumerator Execute()
	{
		...
		for (int i = 0; i < panel.CardLoader.cardList.numItems; i++)
		{
			...
			if (((GObject)entrance).touchable && entrance.TypeController.selectedIndex == 1)
			{
