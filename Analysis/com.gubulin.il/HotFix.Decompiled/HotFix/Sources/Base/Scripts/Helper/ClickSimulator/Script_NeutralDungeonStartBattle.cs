...
public class Script_NeutralDungeonStartBattle : NeutralDungeonClickSimulatorStep
{
	public Script_NeutralDungeonStartBattle(NeutralDungeonLevelLocator levelLocator)
	{
	...
	public override IEnumerator Execute()
	{
		...
		NextStep = new Script_NeutralDungeonEndBattle(LevelLocator);
		yield return null;
	}
}
