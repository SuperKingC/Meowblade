...
public class Script_ThemeDungeonRestartQuickBattle : ThemeDungeonClickSimulatorStep
{
	public Script_ThemeDungeonRestartQuickBattle(ThemeDungeonLevelLocator levelLocator)
	{
