...
public class Script_OffensiveDungeonBackToMilitary : OffensiveDungeonClickSimulatorStep
{
	public Script_OffensiveDungeonBackToMilitary(OffensiveDungeonLevelLocator levelLocator)
	{
