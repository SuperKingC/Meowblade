...
public class Script_ThemeDungeonStartBattle : ThemeDungeonClickSimulatorStep
{
	public Script_ThemeDungeonStartBattle(ThemeDungeonLevelLocator levelLocator)
	{
	...
	public override IEnumerator Execute()
	{
		...
		NextStep = new Script_ThemeDungeonEndBattle(LevelLocator);
		yield return null;
	}
}
