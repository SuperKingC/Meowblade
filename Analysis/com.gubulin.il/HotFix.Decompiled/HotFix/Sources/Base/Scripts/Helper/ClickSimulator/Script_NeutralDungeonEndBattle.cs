...
public class Script_NeutralDungeonEndBattle : NeutralDungeonClickSimulatorStep
{
	public Script_NeutralDungeonEndBattle(NeutralDungeonLevelLocator levelLocator)
	{
