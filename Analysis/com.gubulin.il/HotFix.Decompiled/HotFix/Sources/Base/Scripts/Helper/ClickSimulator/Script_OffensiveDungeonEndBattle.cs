...
public class Script_OffensiveDungeonEndBattle : OffensiveDungeonClickSimulatorStep
{
	public Script_OffensiveDungeonEndBattle(OffensiveDungeonLevelLocator levelLocator)
	{
