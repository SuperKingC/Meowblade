...
public class Script_NeutralDungeonBackToMilitary : NeutralDungeonClickSimulatorStep
{
	public Script_NeutralDungeonBackToMilitary(NeutralDungeonLevelLocator levelLocator)
	{
